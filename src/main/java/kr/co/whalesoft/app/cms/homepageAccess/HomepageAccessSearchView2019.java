...
public class HomepageAccessSearchView2019  extends AbstractJExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> model, WritableWorkbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		new HomepageAccessWorkbook2019().workbookForm(workbook, homepageAccess, list, sheetName, request, response);
	}
