...
public class TrainingCategoryGroup extends PagingUtils {
	...
	public TrainingCategoryGroup() {}

	public TrainingCategoryGroup(String homepage_id){
		setHomepage_id(homepage_id);
	}
	
	public TrainingCategoryGroup(String homepage_id, int large_category_idx){
		setHomepage_id(homepage_id);
