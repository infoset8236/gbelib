...
public class TrainingBook extends PagingUtils {
	/** TEACH_BOOK_TIME **/
	private int training_book_time_idx;  //출석부시간IDX
	...
	private String training_date;  //강좌날짜
	...
	public TrainingBook(String homepage_id, int group_idx, int category_idx, int training_idx) {
	...
	public TrainingBook(Training training, String date) {
		this.homepage_id = training.getHomepage_id();
		this.group_idx = training.getGroup_idx();
		this.category_idx = training.getCategory_idx();
		this.training_idx = training.getTraining_idx();
		this.training_date = date;
	}
	
	
	public int getTraining_book_time_idx() {
		return training_book_time_idx;
	}
	...
	public void setTraining_book_time_idx(int training_book_time_idx) {
		this.training_book_time_idx = training_book_time_idx;
	}
