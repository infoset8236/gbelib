...
public class TeacherReqManage extends PagingUtils {
	...
	private String teacher_text_area; // 비고
	...
	public TeacherReqManage() { }
	
	public TeacherReqManage(String homepage_id, int teacher_idx) {
	...
	public String getTeacher_text_area() {
		return teacher_text_area;
	}

	public void setTeacher_text_area(String teacher_text_area) {
		this.teacher_text_area = teacher_text_area;
	}
}
