...
public class HopeBookTotalExcelView extends AbstractJExcelView {

	@Override
	protected void buildExcelDocument(Map<String, Object> model, WritableWorkbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
		@SuppressWarnings("unchecked")
        Book book = (Book) model.get("hopeElibBook");
		...
		new HopeBookTotalWorkbook().workbookForm(workbook, book, bookList, request, response);
	}
