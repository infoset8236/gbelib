package kr.go.gbelib.app.module.trainingTeacherReqManage;
...
import kr.go.gbelib.app.cms.module.trainingTeacherReqManage.TrainingTeacherReqManage;
import kr.go.gbelib.app.cms.module.trainingTeacherReqManage.TrainingTeacherReqManageService;
import kr.go.gbelib.app.common.api.MemberAPI;
import kr.go.gbelib.app.common.api.PushAPI;

@Controller(value = "userTrainingTeacherReqManage")
@RequestMapping(value = { "/{homepagePath}/module/trainingTeacherReqManage" })
public class TrainingTeacherReqManageController extends BaseController {

	private String basePath = "/homepage/%s/module/trainingTeacherReqManage/";
	...
	public String index(Model model, TrainingTeacherReqManage teacher, HttpServletRequest request) {
...
//		model.addAttribute("subjectCodeList", codeService.getCode("CMS", "C0023"));
	...
	public String edit(Model model, TrainingTeacherReqManage teacher, HttpServletRequest request, HttpServletResponse response) throws Exception {
		Homepage homepage = (Homepage)request.getAttribute("homepage");
		//로그인 체크
		...
		if ( teacher.getEditMode().equals("MODIFY") ) {
			...
			TrainingTeacherReqManage getTeacher =  service.getTeacherApplyOne(teacher);
	...
	public String detail(Model model, TrainingTeacherReqManage teacher, HttpServletRequest request, HttpServletResponse response) throws Exception {
		Homepage homepage = (Homepage)request.getAttribute("homepage");
		
		teacher.setHomepage_id(homepage.getHomepage_id());
		
		TrainingTeacherReqManage getTeacher =  service.getTeacherOne(teacher);
		model.addAttribute("teacher", service.copyObjectPaging(teacher, getTeacher));	
	...
	public String view(Model model, TrainingTeacherReqManage teacher, HttpServletRequest request, HttpServletResponse response) throws Exception {
		Homepage homepage = (Homepage)request.getAttribute("homepage");
	...
	public String apply(Model model, TrainingTeacherReqManage teacher, HttpServletRequest request, HttpServletResponse response) throws Exception {
		Homepage homepage = (Homepage)request.getAttribute("homepage");
...
//		model.addAttribute("subjectCodeList", codeService.getCode("CMS", "C0023"));
	...
	public @ResponseBody JsonResponse save(Model model, TrainingTeacherReqManage teacher, HttpServletRequest request, HttpServletResponse response, BindingResult result) throws Exception {
		Homepage homepage = (Homepage)request.getAttribute("homepage");
...
//			ValidationUtils.rejectIfStringLength(result, "teacher_zipcode", 20, "우편번호");
		...
		if (!result.hasErrors()) {
			if(teacher.getEditMode().equals("ADD")) {
				...
				List<Code> phoneNumbers = codeService.getCode(homepage.getHomepage_id(), "H0005");
