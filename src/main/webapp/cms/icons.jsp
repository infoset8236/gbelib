...
.icons-list li .fa,
.icons-list li .glyphicon{vertical-align:middle;
  font-size:20px;
  margin:0px 10px;
  width:20px;
  text-align:center;
...
<div class="wrapper-white">
	<div class="page-subtitle">
		<i class="fa fa-cog pull-left" style="padding-bottom:30px"></i>
		<h3>Font Awesome</h3>
		...
		<p>
			폰트어썸은 크기, 색상 및 기타 css를 사용하여 아이콘을 폰트처럼 사용할 수 있습니다.<br/>
			사용예(소스): &lt;i class="fa fa-adjust"&gt;&lt;/i&gt;<br/>
			사용예(출력): <i class="fa fa-adjust"></i>
		</p>
	</div>

	<ul class="icons-list" id="fa_icons">
