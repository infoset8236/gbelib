...
<%
	...
	String returnPage = session.getAttribute("gpinAuthRetPage")!=null?(String)session.getAttribute("gpinAuthRetPage"):"https://www.gbelib.kr/intro/join/certReseponse.do";
...
%>
        ...
        if(result)
        {
            ...
            document.getElementById('cert').submit();
                <%
        } else if(!ipCheck){
                %>
...
%>
<form id="cert" action="https://www.gbelib.kr/intro/join/certResponse.do" method="post">
<input type="hidden" name="certType" value="gpin">
</form>