...
<html lang="ko">
	<head>
		...
		<link href="/resources/ict/kioskVertical/css/type_a/info/course_registration.css" rel="stylesheet" type="text/css" />
                            ...
                            <div class="app_choice_gender">
                                <c:choose>
                                    <c:when test="${memberInfo.SEX eq '0001'}">
                                        <div class="button gender_m active">남</div>
                                        <div class="button gender_f">여</div>
                                    </c:when>
                                    <c:otherwise>
                                        <div class="button gender_m">남</div>
                                        <div class="button gender_f active">여</div>
                                    </c:otherwise>
                                </c:choose>
                        ...
                        <c:if test="${teach.agent_yn eq 'Y'}">
                            <div class="apply_name">
							 ...
							 <div class="apply_name">
                                ...
                                <div class="app_choice_gender">
                                    <form:radiobutton id="ss1" path="student_sex" cssClass="custom-radio" value="M" />
