...
<div class="join-wrap">
  ...
  <div class="info">
    <c:if test="${engMode}">
      ...
      &nbsp; Please log in to the homepage and switch to the integrated membership.<br/>
      - In order to use member services, you must give consent to collection and use of personal information below. </b><br/>
    </c:if>
    <c:if test="${!engMode}">
      - 경상북도교육청 도서관통합정보시스템 구축으로 도서관통합정보시스템 이용 기관(경상북도교육청 소속 공공도서관, 정보센터, 문화원)의 회원정보가 통합 운영됩니다.<br/>
      - 홈페이지에 로그인하여 통합회원으로 전환 후 이용하시기 바랍니다.<br/>
      - 회원서비스를 이용하기 위해서는 아래의 <b>이용약관 및 개인정보수집·이용과 제공에 동의</b>하셔야 합니다.</b><br/>
    </c:if>
  </div>
  ...
  <p class="txte">
    ...
    <c:if test="${!engMode}">
      통합회원이 되시면 하나의 회원정보로 도서관통합정보시스템 이용 기관(경상북도교육청 소속 공공도서관, 정보센터, 문화원)의  홈페이지 서비스 및 자료대출 서비스 등을 이용할 수 있습니다.
    </c:if>
  <div class="Box">
    <c:if test="${engMode}">
      <ul class="lib-list">
    ...
    <c:if test="${!engMode}">
      <ul id="webList" class="webList lib-list">
      ...
      <ul id="mobileList" class="mobileList lib-list">

        <li>경상북도교육청 통합공공도서관</li>
        <li>경상북도교육청 전자도서관</li>
        <li>경상북도교육청 정보센터</li>
        <li>경상북도교육청 구미도서관</li>
        <li>경상북도교육청 영주선비도서관</li>
        <li>경상북도교육청 영주선비도서관 풍기분관</li>
        <li>경상북도교육청 상주도서관</li>
        <li>경상북도교육청 상주도서관 화령분관</li>
        <li>경상북도교육청 안동도서관</li>
        <li>경상북도교육청 안동도서관 용상분관</li>
        <li>경상북도교육청 안동도서관 풍산분관</li>
        <li>경상북도교육청 문화원</li>
        <li>경상북도교육청 영일도서관</li>
        <li>경상북도교육청 청도도서관</li>
        <li>경상북도교육청 영덕도서관</li>
    ...
    <c:if test="${!engMode}">
      ...
      <div class="Box" style="height:200px">
        ...
        <font size="2">
          ...
          <ul>
            <li style="font-size: 20px; font-weight: 700; color: blue; text-decoration: underline">  1) 홈페이지 서비스 : 자료대출관리, 평생학습 수강신청, 게시물 등록, 도서관 홍보 및 교육 활성화 등</li>
            <li style="font-size: 20px; font-weight: 700; color: blue; text-decoration: underline">  2) 독서문화/평생교육 서비스 : 도서관 행사, 체험 학습, 평생학습 신청 및 수강 등</li>
            <li style="font-size: 20px; font-weight: 700; color: blue; text-decoration: underline">  3) 자료대출 서비스 : 자료이용현황, 자료의 예약·신청·대출, 전자도서관 이용 등</li>
          </ul>
          ...
          <table style="boder:1; margin:auto; text-align:center;">
            ...
            <tr>
              <td style="font-size: 20px; font-weight: 700; color: blue; text-decoration: underline" class="first td1">홈페이지 서비스</td>
              <td rowspan="3" style="font-size: 20px; font-weight: 700; color: blue; text-decoration: underline" class="td2">회원탈퇴시까지(2년 주기 재동의)</td>
      ...
      <div class="Box">
          <ul class="lib-list webList">
            ...
            <li>경상북도교육청 <br class="test"/>안동도서관용상분관</li>
            <li>경상북도교육청 <br class="test"/>점촌도서관</li>
            <li>경상북도교육청 <br class="test"/>성주도서관</li>

            <li>경상북도교육청 <br class="test"/>안동도서관풍산분관</li>
            <li>경상북도교육청 <br class="test"/>점촌도서관가은분관</li>
            <li>경상북도교육청 <br class="test"/>칠곡도서관</li>

            <li>경상북도교육청 <br class="test"/>상주도서관</li>
            <li>경상북도교육청 <br class="test"/>삼국유사군위도서관</li>
            <li>경상북도교육청 <br class="test"/>예천도서관</li>

            <li>경상북도교육청 <br class="test"/>상주도서관화령분관</li>
            <li>경상북도교육청 <br class="test"/>의성도서관</li>
            <li>경상북도교육청 <br class="test"/>봉화도서관</li>
            ...
            <li>경상북도교육청 <br class="test"/>영주선비도서관풍기분관</li>
            <li>경상북도교육청 <br class="test"/>영양도서관</li>
            <li>경상북도교육청 <br class="test"/>울릉도서관</li>
          ...
          <ul class="lib-list mobileList">
            ...
            <li>경상북도교육청<br/>문화원</li><li>경상북도교육청<br/>삼국유사군위도서관</li>
            <li>경상북도교육청<br/>구미도서관</li><li>경상북도교육청<br/>의성도서관</li>
            <li>경상북도교육청<br/>안동도서관</li><li>경상북도교육청<br/>청송도서관</li>
            <li>경상북도교육청<br/>안동도서관용상분관</li><li>경상북도교육청<br/>영양도서관</li>
            <li>경상북도교육청<br/>안동도서관풍산분관</li><li>경상북도교육청<br/>영덕도서관</li>
            <li>경상북도교육청<br/>상주도서관</li><li>경상북도교육청<br/>청도도서관</li>
            <li>경상북도교육청<br/>상주도서관화령분관</li><li>경상북도교육청<br/>고령도서관</li>
            <li>경상북도교육청<br/>영주선비도서관</li><li>경상북도교육청<br/>성주도서관</li>
            <li>경상북도교육청<br/>영주선비도서관풍기분관</li><li>경상북도교육청<br/>칠곡도서관</li>
            <li>경상북도교육청<br/>영일도서관</li><li>경상북도교육청<br/>예천도서관</li>
            <li>경상북도교육청<br/>외동도서관</li><li>경상북도교육청<br/>봉화도서관</li>
            <li>경상북도교육청<br/>금호도서관</li><li>경상북도교육청<br/>울진도서관</li>
            <li>경상북도교육청<br/>점촌도서관</li><li>경상북도교육청<br/>울릉도서관</li>
            <li>경상북도교육청<br/>점촌도서관가은분관</li>

          </ul>
        </div>
      <br>

      <h5>2. 제공받는 자의 개인정보 이용 목적 : 개인정보 수집·이용의 목적과 같음</h5>
      <br>

      <h5>3. 제공하는 개인정보 항목 : 개인정보 수집·이용의 항목과 같음</h5>
      <br>

      <h5>4. 제공받는 자의 개인정보 보유 및 이용기간 : 개인정보 수집·이용의 보유 및 이용기간과 같음</h5>
      <br>

      <h5>5. 동의거부 권 및 불이익: 개인정보 제3자 제공에 대한 동의를 거부 할 권리가 있으며 거부할 경우에는 회원가입을 할 수 없습니다.</h5><br>
      </font>
        </div>
        <div class="agree_codes" >
          <div class="checkbox">
