...
<div class="wrapper-bbs">
	<div class="bbs-view">
		...
		<div class="bbs-view-body">
			작품명 : ${board.imsi_v_6}<br/>
			<c:if test="${authMBA}">
			생년월일 : ${board.imsi_v_1}<br/>
			학교 : ${board.imsi_v_2}<br/>
			학년 : ${board.imsi_v_3}<br/>
			휴대전화번호 : ${board.imsi_v_4}<br/>
			이메일 : ${board.imsi_v_5}<br/>
			</c:if>
			<br/>작품설명 <br/>${fn:replace(board.content, crlf, '<br/>')}
		</div>
		<div class="bbs-view-header">
			<dl>
