			...
			<dl>
				...
				<dd class="info">
					...
					<div class="panel-right">
						<a href="#bbs-comment">
						<i>댓글</i><span id="comment_count">${board.comment_count}</span></a>
...
<script>
    $(function() {
        $(document).ajaxComplete(function (e) {
            e.preventDefault();
            if ($('#bbs-comment .bbs-comment-title em').text() !== '') {
                $('#comment_count').text($('#bbs-comment .bbs-comment-title em').text());
            }
        })
    })
</script>
