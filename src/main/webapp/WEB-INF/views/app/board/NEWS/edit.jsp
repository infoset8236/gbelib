		...
		<tbody>
			...
			<tr>
				...
				<td colspan="3">
					...
					<label for="push_send_yn_no">아니요</label>
				</td>
			</tr>
			</c:if>
			<tr>
			...
			<c:if test="${boardManage.file_use_yn eq 'N'}">
				<form:hidden path="boardFileArray" multiple="multiple" size="6" title="파일을 여기에 드래그 할 수 있습니다."/>
			</c:if>
		</tbody>
	</table>
