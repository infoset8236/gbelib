...
<form:form id="memberGroupOne" modelAttribute="memberGroup" action="save.do" method="post" onsubmit="return false;">
...
<table class="type2">
	...
	<tbody>
		...
		<tr>
			<th>권한그룹명 <em>*</em></th>
			<td>
				<form:input path="member_group_name" cssStyle="width:178px;" cssClass="text"/>
			</td>
		</tr>
		<tr>
			<th>설명</th>
