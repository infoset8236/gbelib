...
$(function() {
	$('a.resve-cancel').on('click', function(e) {
		...
		$('#resveCancelForm #vSeqNo').val($(this).attr('vSeqNo'));
...
<div class="book-list">
	<c:if test="${empty nightResveDetail}"><h3>야간예약중인 도서 내역이 없습니다.</h3></c:if>
	<c:if test="${not empty nightResveDetail}">
		<c:forEach items="${nightResveDetail.dsMyLibraryListD}" var="i">
			<div class="row">
				<div class="box">
					<div class="item">
						<div class="bif">
							<div class="top">
								...
								<div class="control">
									<c:if test="${i.STATUS_NAME != '취소'}">
									<a href="" class="btn resve-cancel" vSeqNo="${i.SEQ_NO}">예약 취소</a>
									</c:if>
								</div>
							</div>
...
<div class="button center" style="padding-bottom:20px;">
	<a href="#" class="btn" id="view-list"><i class="fa fa-list"></i><span>야간목록 보기</span></a>
</div>