...
$(function() {
	$('#search-btn').on('click', function(e) {
		...
		doGetLoad('index.do', serializeCustom($('#lnkBookListForm')));
	});
...
<form:form id="lnkBookListForm" modelAttribute="librarySearch" action="index.do" method="GET" onsubmit="return false;">
