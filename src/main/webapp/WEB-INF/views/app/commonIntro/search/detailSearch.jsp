...
// 	});
	...
	$('a#detailSearch').on('click', function(e) {
		e.preventDefault();
		$('div#detailSearchBox').slideToggle(function() {
			if ($('div#detailSearchBox').is(':visible')) {
				$('input#detailSearchYN').val('Y');
			} else {
				$('input#detailSearchYN').val('N');
			}	
		});
	});
...
<form:form modelAttribute="librarySearch" action="detailSearch.do" method="POST">
	<form:hidden path="allBookListStr" value="${result.allBookListStr}"/>
	<form:hidden path="detailSearchYN"/>
	<form:hidden path="menu_idx"/>
	...
	<div class="search-wrap">
		...
		<div class="search-form">
			<table class="nohead">
				...
				<tr>
					<th>
						<form:select path="searchType1" cssClass="selectmenu" cssStyle="width:100%;">
							...
							<form:option value="KEYWORD" label="키워드"></form:option>
						</form:select>
					</th>
					<td>
						<form:input path="searchKeyowrd1" cssClass="text" cssStyle="width: 98%"/>
					</td>
					<th>
						<form:select path="logicFunction1" cssClass="selectmenu" cssStyle="width:100%;">
							<form:option value="AND" label="AND"></form:option>
							<form:option value="OR" label="OR"></form:option>
							<form:option value="NOT" label="NOT"></form:option>
						</form:select>
					</th>
				</tr>
				<tr>
					<th>
						<form:select path="searchType2" cssClass="selectmenu" cssStyle="width:100%;">
							<form:option value="TITLE" label="서명"></form:option>
							<form:option value="AUTHOR" label="저자"></form:option>
							<form:option value="PUBLISHER" label="출판사"></form:option>
							<form:option value="KEYWORD" label="키워드"></form:option>
					...
					<td>
						<form:input path="searchKeyowrd2" cssClass="text" cssStyle="width: 98%"/>
					</td>
					<th>
						<form:select path="logicFunction2" cssClass="selectmenu" cssStyle="width:100%;">
							<form:option value="AND" label="AND"></form:option>
							<form:option value="OR" label="OR"></form:option>
							<form:option value="NOT" label="NOT"></form:option>
						</form:select>
				...
				<tr>
					<th>
						<form:select path="searchType3" cssClass="selectmenu" cssStyle="width:100%;">
							<form:option value="TITLE" label="서명"></form:option>
							<form:option value="AUTHOR" label="저자"></form:option>
							<form:option value="PUBLISHER" label="출판사"></form:option>
							<form:option value="KEYWORD" label="키워드"></form:option>
					...
					<td>
						<form:input path="searchKeyowrd3" cssClass="text" cssStyle="width: 98%"/>
					</td>
					<th>
						<form:select path="logicFunction3" cssClass="selectmenu" cssStyle="width:100%;">
							<form:option value="AND" label="AND"></form:option>
							<form:option value="OR" label="OR"></form:option>
							<form:option value="NOT" label="NOT"></form:option>
						</form:select>
				...
				<tr>
					<th>
						<form:select path="searchType4" cssClass="selectmenu" cssStyle="width:100%;">
							<form:option value="TITLE" label="서명"></form:option>
							<form:option value="AUTHOR" label="저자"></form:option>
							<form:option value="PUBLISHER" label="출판사"></form:option>
							<form:option value="KEYWORD" label="키워드"></form:option>
					...
					<td>
						<form:input path="searchKeyowrd4" cssClass="text" cssStyle="width: 98%"/>
					</td>
					<th>
						<form:select path="logicFunction4" cssClass="selectmenu" cssStyle="width:100%;">
							<form:option value="AND" label="AND"></form:option>
							<form:option value="OR" label="OR"></form:option>
							<form:option value="NOT" label="NOT"></form:option>
						</form:select>
				...
				<tr>
					...
					<td>
						<form:input path="isbnSearch" cssClass="text" cssStyle="width: 90%"/>
					</td>
					<th>
						<form:select path="logicFunction4" cssClass="selectmenu" cssStyle="width:100%;">
							<form:option value="AND" label="AND"></form:option>
				...
				<tr>
					...
					<td colspan="2">
						<form:input path="kdcSearch" cssClass="text" cssStyle="width: 98%"/>
					</td>
				</tr>
				<tr>
					<th>
					...
					<td colspan="2" style="text-align: left;">
						<form:select path="langType" cssClass="selectmenu" cssStyle="width:20%;">
							<form:option value="AND" label="AND"></form:option>
							<form:option value="OR" label="OR"></form:option>
							<form:option value="NOT" label="NOT"></form:option>
						</form:select>
				...
				<tr>
					...
					<td colspan="2" style="text-align: left;">
						<form:input path="searchStYear" maxlength="4" numberOnly="true" cssStyle="width:10%" cssClass="text"/>년 부터 <form:input path="searchEdYear" maxlength="4" numberOnly="true" cssStyle="width:10%" cssClass="text"/> 
					</td>
				</tr>
				<tr>
					<td colspan="3" style="">
						<button style="width: 50%;">상세 검색</button>
					</td>
				</tr>
			</table>
			<p style="height:auto">
		...
		<br/>
		<div id="detailSearchBox" class="bbs-notice" style="margin-bottom:20px; display: none;" >
		<h4>상세검색</h4>
...
<!-- 						</select> -->
			...
			<div class="ws-filter" id="ageLoanBest" style="padding-bottom: 20px; display: none;">
			...
			<div class="ws-filter" id="hotTrend" style="height: 275px; <c:if test="${fn:length(result.data) < 1 and !showSmain}">clear: both;</c:if>">
				<h4>실시간 검색어 순위</h4>
