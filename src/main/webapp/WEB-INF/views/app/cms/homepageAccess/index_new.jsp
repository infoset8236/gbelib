...
$(function(){
	...
	$('a#excelDownload').on('click', function(e) {
		...
		$('#homepageAccessSearch').attr('action', '/cms/homepageAccess/excelDownload2019.do');
	...
	$('a#csvDownload').on('click', function(e) {
		e.preventDefault();
		$('#homepageName').val($('#homepageId option:selected').text());
		$('#homepageAccessSearch').attr('action', '/cms/homepageAccess/csvDownload2019.do');
		$('#homepageAccessSearch').submit();
	});
...
<div class="search">
	<form:form id="homepageAccessSearch" modelAttribute="homepageAccess" action="/cms/homepageAccess/excelDownload2019.do" method="post" style="display:inline-flex">
			...
			<c:when test="${member.admin}">
				<form:select id="homepageId" path="homepage_id" class="selectmenu-search" style="width:250px">
					...
					<c:forEach var="i" varStatus="status" items="${homepageList}">
						<c:if test="${i.homepage_id ne 'c0' and i.homepage_id ne 'h34' and i.homepage_id ne 'h32'
							and i.homepage_id ne 'h27' and i.homepage_id ne 'c1'}">
