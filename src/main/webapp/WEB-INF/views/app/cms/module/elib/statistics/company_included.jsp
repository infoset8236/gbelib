...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
	<table class="type1 center" id="data-table">
		...
		<tbody>
			...
			<tr>
				<td>WOONGJIN</td>
				<td><fmt:formatNumber value="${0 + elibStatisticsMap['EBK.YES2.-']}" pattern="#,###" /></td>
			...
			<tr>
				<th>소계</th>
				<th>-</th>
				<th><fmt:formatNumber value="${0 + elibStatisticsMap['EBK.KYOB.-'] + elibStatisticsMap['EBK.Y2BK.-'] + elibStatisticsMap['EBK.FXLI.-'] + elibStatisticsMap['EBK.YESB.-'] + elibStatisticsMap['EBK.OPMS.-'] + elibStatisticsMap['EBK.YES2.-']}" pattern="#,###" /></th>
			...
			<tr>
				<td>OPMS</td>
				<td><fmt:formatNumber value="${0 + elibStatisticsMap['ADO.OPMS.-']}" pattern="#,###" /></td>
			...
			<tr>
				<th>소계</th>
				<th>-</th>
				<th><fmt:formatNumber value="${0 + elibStatisticsMap['ADO.FXLI.-'] + elibStatisticsMap['ADO.HANS.-'] + elibStatisticsMap['ADO.CONT.-'] + elibStatisticsMap['ADO.OPMS.-']}" pattern="#,###" /></th>
			...
			<tr class="strong">
				...
				<th>
					<fmt:formatNumber value="${0 + 
						elibStatisticsMap['EBK.KYOB.-'] + elibStatisticsMap['EBK.Y2BK.-'] + elibStatisticsMap['EBK.FXLI.-'] + elibStatisticsMap['EBK.YESB.-'] + elibStatisticsMap['EBK.YES2.-'] +
