			...
			success : function(data) {
				...
				$tree.on('tree.click', function(e) {
	    			...
	    			if(selected_node.id == 'ROOT') {
	    				...
	    				$.ajax({
							url : 'getCodeGroupOne.do?group_id=' + selected_node.id,
							async : true ,
							success : function(data) {
								data = eval(data);
								...
								$('#codeLayer').load('code.do?editMode=ADD&group_id=' + selected_node.id);
							}
						});	
	    			}
...
%>
<form:form id="form_1" modelAttribute="teachClassCode" onsubmit="return false;">
