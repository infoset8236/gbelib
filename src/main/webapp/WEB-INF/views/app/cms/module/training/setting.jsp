		...
		buttons: [
			{
				...
				"class": 'btn btn1',
				click: function() {
					if ( doAjaxPost($('#trainingSettingForm')) ) {
						location.reload();
					}
				}
			},{
...
<form:form id="trainingSettingForm" modelAttribute="trainingSetting" method="post" action="saveSetting.do">
	...
	<div class="ui-state-highlight">
		* 해당 설정은 도서관의 모든 연수에 대하여 1인당 강좌수 제한을 설정합니다.<br/>
