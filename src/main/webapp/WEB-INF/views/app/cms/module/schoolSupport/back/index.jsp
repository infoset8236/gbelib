				...
				<c:forEach var="i" varStatus="status" items="${calendarList}">
					<tr>
						<c:choose>
							...
							<c:otherwise>
								<td class="top" style="vertical-align: top; max-width: 80px;">
									<c:set var="planDate" value="${schoolSupport.plan_date}-${i.sun < 10?'0':''}${i.sun}"/>
									<div style="background: #ff4e4e; color: white; margin-bottom: 5px;font-size: 15px;font-weight: bold;">${i.sun}</div>
									<c:forEach items="${schoolSupportRepo[planDate]}" var="one">
						...
						<c:choose>
							...
							<c:otherwise>
								<td class="top" style="vertical-align: top; max-width: 80px;">
									<c:set var="planDate" value="${schoolSupport.plan_date}-${i.mon < 10?'0':''}${i.mon}"/>    
						...
						<c:choose>
							...
							<c:otherwise>
								<td class="top" style="vertical-align: top; max-width: 80px;">
									<c:set var="planDate" value="${schoolSupport.plan_date}-${i.tue < 10?'0':''}${i.tue}"/>
						...
						<c:choose>
							...
							<c:otherwise>
								<td class="top" style="vertical-align: top; max-width: 80px;">
									<c:set var="planDate" value="${schoolSupport.plan_date}-${i.wed < 10?'0':''}${i.wed}"/>
						...
						<c:choose>
							...
							<c:otherwise>
								<td class="top" style="vertical-align: top; max-width: 80px;">
									<c:set var="planDate" value="${schoolSupport.plan_date}-${i.thu < 10?'0':''}${i.thu}"/>
						...
						<c:choose>
							...
							<c:otherwise>
								<td class="top" style="vertical-align: top; max-width: 80px;">
									<c:set var="planDate" value="${schoolSupport.plan_date}-${i.fri < 10?'0':''}${i.fri}"/>
						...
						<c:choose>
							...
							<c:otherwise>
								<td class="top" style="vertical-align: top; max-width: 80px;">
									<c:set var="planDate" value="${schoolSupport.plan_date}-${i.sat < 10?'0':''}${i.sat}"/>
