		...
		buttons: [
			{
				...
				click: function() {
					...
					$('#trainingTerms').ajaxSubmit(option);
				}
			},{
				text: "취소",
				"class": 'btn',
...
<form:form modelAttribute="trainingTerms" action="save.do" method="POST" onsubmit="return false;" enctype="multipart/form-data">
