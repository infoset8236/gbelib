	...
	<table class="type2">
		<colgroup>
       	...
       	<tbody>
	        ...
	        <tr>
	         	...
	         	<td><form:input path="applicant_zipcode" class="text" readonly="true" cssStyle="width: 15%;"/>
			...
			<tr>
				...
				<td>
					...
					<input id="applicant_cell_phone_2" style="width:60px;" class="text" maxlength="4" numberonly="true" /> -
					<input id="applicant_cell_phone_3" style="width:60px;" class="text" maxlength="4" numberonly="true" />
		...
		<table class="type2">
	        ...
	        <tr>
	         	...
	         	<td><form:input path="student_zipcode" class="text" readonly="true" cssStyle="width: 25%;"/>
