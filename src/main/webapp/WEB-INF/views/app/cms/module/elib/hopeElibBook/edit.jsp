...
<form:form id="bookForm" modelAttribute="hopeElibBook" method="post" action="/cms/module/elib/hopeElibBook/EBK/save.do" >
    ...
    <table class="type2">
        ...
        <tr>
            ...
            <td>
                <c:choose>
                    <c:when test="${hopeElibBook.editMode == 'ADD'}">
