...
$(function() {
	$('a#excelDownload').on('click', function(e) {
		...
		$('#hiddenForm').attr('action', 'summary_excel.do').submit();
	...
	$('a#csvDownload').on('click', function(e) {
		...
		$('#csv_string').val(csv);
		$('#csv_filename').val('전자도서관_연령별별통계_'+formatDate(new Date())+'.csv');
		$('#csvForm').submit();
	});
...
<form id="csvForm" method="POST" action="summary_csv.do">
<input type="hidden" id="csv_string" name="csv_string" value="">
<input type="hidden" id="csv_filename" name="filename" value="전자도서관_연령별통계.csv">
</form>
<form:form id="elibStatisticsListForm"  modelAttribute="elibStatistics" action="summary.do" >
...
<form:hidden path="library_code" value="${library_code}"/>
	...
	<jsp:include page="/WEB-INF/views/app/cms/module/elib/statistics/summary_included.jsp" flush="false"/>
