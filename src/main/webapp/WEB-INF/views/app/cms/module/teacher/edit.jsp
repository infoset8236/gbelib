	...
	<table class="type2">
		<colgroup>
       	...
       	<tbody>
        	...
        	<tr>
	         	<th>우편번호</th>			
	         	<td><form:input path="teacher_zipcode" class="text" maxlength="15"/> <button class="btn findPostCode" keyValue1="#teacher_zipcode" keyValue2="#teacher_address">우편번호 찾기</button></td>
        	</tr>
			<tr>
	         	<th>주소</th>			
