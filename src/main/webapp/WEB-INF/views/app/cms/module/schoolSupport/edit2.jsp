...
<form:form id="schoolSupportForm" modelAttribute="schoolSupport" method="post" action="save.do" >
	...
	<table class="type2 center">
       	<tr>
	     	<th colspan="4"><b style="margin-left: 40%;">학 교 도 서 관 현 황</b></th>
	     	<th>상태</th>
       		<td>
	    ...
	    <tr>
       	...
       	<tr>
       		...
       		<td>
				...
				<form:input path="member_phone1" style="width:30px;" class="text" maxlength="3" numberonly="true" /> -
				<form:input path="member_phone2" style="width:40px;" class="text" maxlength="4" numberonly="true" /> -
				<form:input path="member_phone3" style="width:40px;" class="text" maxlength="4" numberonly="true" />
       		</td>
       		<th colspan="2">휴대전화번호</th>
       		<td>
       			<form:hidden path="member_cell_phone"/>
				<form:input path="member_cell_phone1" style="width:30px;" class="text" maxlength="3" numberonly="true" /> -
				<form:input path="member_cell_phone2" style="width:40px;" class="text" maxlength="4" numberonly="true" /> -
				<form:input path="member_cell_phone3" style="width:40px;" class="text" maxlength="4" numberonly="true" />
       		</td>
       	</tr>
	</table>
</form:form>
