...
$(function(){
	...
	$('a.search-btn').on('click', function(e) {
		e.preventDefault();
		$('#dialog-3').load('getTrainingCertificateListByDate.do?'+ serializeCustom($('#certStudentSearchForm')));
	});
...
<form:form id="certStudentSearchForm" modelAttribute="student" action="getTrainingCertificateListByDate.do" onsubmit="return false;">
