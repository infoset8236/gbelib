...
.pop_container .drag_area .bg{display:block;position:absolute;top:0;left:0;width:341px;height:129px;background:#fdfdfd url(/resources/cms/smart_editor/photo_uploader/popup/../../img/photoQuickPopup/bg_drag_image.png) 0 0 no-repeat}
...
jQuery(document).ready(function() {
	load_tempfile_table('${homepage_id}', '${menu_idx}');
});
	
function load_tempfile_table(homepage_id, menu_idx) {
	jQuery('div#tempfile_table').load('get_temp_files.do?homepage_id=' + homepage_id + '&menu_idx=' + menu_idx);
}
</script>
</head>
<body>
<div>
<div id="pop_wrap" style="float: left;">
	<!-- header -->
    <div id="pop_header">
        <h1>사진 첨부하기</h1>
    </div>
	...
	<div id="pop_container2" class="pop_container2">
    	<!-- content -->
		<form id="editor_upimage" name="editor_upimage" action="/cms/menu/imgUpload.do" method="post" enctype="multipart/form-data" onSubmit="return false;">
		<input type="hidden" name="_csrf" value="${_csrf.token}">
        <div id="pop_content2">
        	<input type="hidden" name="homepage_id" value="${homepage_id}">
        	<input type="hidden" name="menu_idx" value="${menu_idx}">
			<input type="file" class="upload" id="uploadInputBox" name="menu_temp_file">
    ...
    <div id="pop_footer">
	    <div class="btn_area">
            <a href="#"><img src="/resources/cms/smart_editor/photo_uploader/popup/../../img/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm"></a>
            <a href="#"><img src="/resources/cms/smart_editor/photo_uploader/popup/../../img/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel"></a>
        </div>
    </div>
    <!-- //footer -->
</div>
<div id="tempfile_table" style="float: right;">
	
</div>
</div>
<script type="text/javascript" src="/resources/cms/smart_editor/photo_uploader/popup/jindo.min.js" charset="utf-8"></script>
<script type="text/javascript" src="/resources/cms/smart_editor/photo_uploader/popup/jindo.fileuploader.js" charset="utf-8"></script>
<script type="text/javascript" src="/resources/cms/smart_editor/photo_uploader/popup/attach_photo_menuHtml.js" charset="utf-8"></script>
