...
<div id="wrap" class="main_bg">
	...
	$(function() {
		...
		$(window).resize(function() {
		   	$('div#new_book img').width($('#tmpImg').width());
		   	$('div#new_book img').height($('#tmpImg').height());
	   	});
		...
		$('#main3 .main3-wrap .title ul li').on('click', function() {
			...
			if (!$(this).hasClass("on")) {
				if (tab == 'tab1') {
					...
					$('#more-link').attr('href', '/${homepage.context_path}/board/index.do?menu_idx=13&manage_idx=339');
					$('#main3 div.list .bookListTop').load('bestBook.do?manage_idx=339&count=10');
				}
			...
			<div class="sections main0">
				...
				<div class="main0-bottom">
					...
					<div class="qmenu">
						<ul>
							<li class="qm1">
									<a href="/${homepage.context_path}/intro/search/hope/search.do?menu_idx=16&editMode=NOAJAX" title="희망도서신청">
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/common/img/main_type02/q1.png" data-onsrc="/resources/common/img/main_type02/q1-on.png" data-outsrc="/resources/common/img/main_type02/q1.png" alt="희망도서신청"></div>
							...
							<li class="qm2">
									...
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/common/img/main_type02/q2.png" data-onsrc="/resources/common/img/main_type02/q2-on.png" data-outsrc="/resources/common/img/main_type02/q2.png" alt="통합도서관"></div>
							...
							<li class="qm3">
									...
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/common/img/main_type02/q3.png" data-onsrc="/resources/common/img/main_type02/q3-on.png" data-outsrc="/resources/common/img/main_type02/q3.png" alt="대출조회·예약"></div>
							...
							<li class="qm4">
									...
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/common/img/main_type02/q4.png" data-onsrc="/resources/common/img/main_type02/q4-on.png" data-outsrc="/resources/common/img/main_type02/q4.png" alt="이용안내"></div>
							...
							<li class="qm5">
									...
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/common/img/main_type02/q5.png" data-onsrc="/resources/common/img/main_type02/q5-on.png" data-outsrc="/resources/common/img/main_type02/q5.png" alt="전자도서관"></div>
			...
			<div class="main1_wrap sections">
				<div class="main1-left-box">
					<div class="notice-box">
						<div class="title">
							<h3>공지사항</h3>
							<a href="/${homepage.context_path}/board/index.do?menu_idx=58&manage_idx=338" title="공지사항 더보기 버튼">
		...
		<div id="main2" class="section">
			<div class="main2-wrap mid-sections">
				...
				<div class="event-box">
					<div class="title">
						<h3>EVENT</h3>
						<a href="/${homepage.context_path}/module/teach/index.do?menu_idx=155&searchCate1=18" title="행사 더보기 버튼">
					...
					<div class="list">
						<ul>
							<c:forEach var="i" items="${teachList}">
								<li>
									<a href="/${homepage.context_path}/module/teach/detail.do?menu_idx=155&searchCate1=${i.large_category_idx}&group_idx=${i.group_idx}&category_idx=${i.category_idx}&teach_idx=${i.teach_idx}&homepage_id=${i.homepage_id}">
										<div>
											<h3>${i.teach_name }</h3>
					...
					<div class="banner-wrap type6">
						...
						<div class='banner-t6-after'>
							<div class="control">
								...
								<a class="more" href="/${homepage.context_path}/bannermap/index.do?menu_idx=170"><img src="/resources/homepage/gbelib/img/section04/banner-more-btn.png" alt="더보기" /><span class="blind">더보기</span></a>
							</div>
						</div>
					</div>
				</div>
