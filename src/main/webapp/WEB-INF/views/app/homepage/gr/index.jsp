		...
		$('#main3 .main3-wrap .title ul li').on('click', function() {
			...
			if (!$(this).hasClass("on")) {
				if (tab == 'tab1') {
					...
					$('#more-link').attr('href', '/${homepage.context_path}/board/index.do?menu_idx=21&manage_idx=490');
					$('#main3 div.list .bookListTop').load('bestBook.do?manage_idx=490&count=10');
				}
		...
		<div id="main0" class="section">
			<div class="main-visual">
				<div class="main-txt-area">
					<div class="main-txt">
						<div class="txt-wrap"><span class="txt01">당신의 <b>꿈</b>과<br class="web-br"/> <b>행복</b>이 함께하는 곳</span><br/> <span class="txt02">경상북도교육청 고령도서관입니다</span></div> 
					</div>
				</div>
					...
					<div class="main-box">
						<div class="qmenu">
							<ul>
								...
								<li class="qm6">
									<a href="/${homepage.context_path}/board/index.do?menu_idx=74&manage_idx=493" title="자주하는질문">
			...
			<div class="main1_wrap mid-sections">
				<div class="main1-left-box">
					<div class="notice-box">
						<div class="title">
							<h3>공지사항</h3>
							<a href="/${homepage.context_path}/board/index.do?menu_idx=58&manage_idx=491" title="공지사항 더보기 버튼">
		...
		<div id="main2" class="section">
			<div class="main2-wrap">
				...
				<div class="event-box">
					...
					<div class="culList">
						<ul>
							<c:forEach var="i" items="${teachList}">
								<li>
									<a href="/${homepage.context_path}/module/teach/detail.do?menu_idx=169&searchCate1=${i.large_category_idx}&group_idx=${i.group_idx}&category_idx=${i.category_idx}&teach_idx=${i.teach_idx}&homepage_id=${i.homepage_id}">
										<div>
											<h3>${i.teach_name }</h3>
					...
					<div class="more">
						<a href="/${homepage.context_path}/module/teach/index.do?menu_idx=169&searchCate1=16,17" title="행사리스트 더보기 버튼">
							행사리스트 더보기 +
						</a>
					</div>
				</div>
					...
					<div class="banner-wrap type6">
						...
						<div class='banner-t6-after'>
							<div class="control">
								...
								<a class="more" href="/${homepage.context_path}/bannermap/index.do?menu_idx=161"><img src="/resources/homepage/gbelib/img/section04/banner-more-btn.png" alt="더보기" /><span class="blind">더보기</span></a>
							</div>
						</div>
					</div>
				</div>
