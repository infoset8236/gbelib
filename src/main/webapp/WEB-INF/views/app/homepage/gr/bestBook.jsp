				...
				<div class="img-box">
					<c:choose>
						<c:when test="${fn:indexOf(i.preview_img, 'http') > -1 }">
							<img src="${i.preview_img}" alt="${i.title}" title="${i.title}" onError="src='/resources/homepage/geic/img/noimg2.png'"/>
						</c:when>
						<c:otherwise>
							<img src="/data/board/${i.manage_idx}/${i.board_idx}/${i.preview_img}" alt="${i.title}" title="${i.title}" onError="src='/resources/homepage/geic/img/noimg2.png'"/>
						</c:otherwise>
					</c:choose>
				</div>
				<div class="txt-box">
