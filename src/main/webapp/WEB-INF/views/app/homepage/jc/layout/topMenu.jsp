...
<div id="m-util" class="no5">
	<ul>
		...
		<li><a href="http://www.gbelib.kr/jcge/index.do" target="_blank">가은분관</a></li>
		<li><a href="https://www.instagram.com/jeomchonlib/" target="_blank">인스타그램</a></li>
...
<div class="head">
		<div class="Gnb">
			...
			<div class="wide-sections">
				<h1 style="margin-top: 10px"><a href="http://www.gbelib.kr/${homepage.context_path}/index.do"><img src="/resources/homepage/${homepage.context_path}/img/logo.png" alt="${homepage.homepage_name}"/></a></h1>
				...
				<div class="g-menu">
					...
					<div class="mmode">
						<c:choose>
							...
							<a href="https://www.gbelib.kr/${homepage.context_path}/module/myDashBoard/index.do?menu_idx=200" class="btn4">
           						<i class="fa fa-bookmark"></i>
          							 <span>나의도서관</span>
       						  </a>
							<a href="https://www.gbelib.kr/${homepage.context_path}/html/mobileCard.do?menu_idx=231" class="btn2" style="background:#8008d5;">
							<i class="fa fa-bookmark"></i>
								 <span>모바일회원증</span>
							</a>
