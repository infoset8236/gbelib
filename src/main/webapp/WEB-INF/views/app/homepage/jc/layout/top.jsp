	...
	<div class="tnb">
		<div class="util-left">
			<ul>
				...
				<li><a href="https://www.gbelib.kr/jcge/index.do" target="_blank">가은분관</a></li>
				<li><a href="https://www.instagram.com/jeomchonlib/" target="_blank">점촌도서관 인스타그램</a></li>
			</ul>
		</div>
		<div class="util-right">
			...
			<c:choose>
				<c:when test="${sessionScope.member.loginType eq 'HOMEPAGE' and sessionScope.member.login}">
					...
					<li><a href="https://www.gbelib.kr/${homepage.context_path}/module/myDashBoard/index.do?menu_idx=200" class='tnb-box-1'>나의도서관</a></li>
				</c:when>
