...
<script type="text/javascript">
	$(function() {
		...
		$('#main3 div.list .bookListTop').load('bestBook.do?manage_idx=293&count=10');
		...
		$('#main3 .main3-wrap .title ul li').on('click', function() {
			...
			if (!$(this).hasClass("on")) {
				if (tab == 'tab1') {
					...
					$('#more-link').attr('href', '/${homepage.context_path}/board/index.do?menu_idx=149&manage_idx=293');
					$('#main3 div.list .bookListTop').load('bestBook.do?manage_idx=293&count=10');
				}
	...
	<div id="fullpage" >
				...
				<div class="sections">
					<div class="main0-box-top">
						<div class="main0-inner-left">
							<div class="slogan">
								<p class="text-01">경상북도교육청 점촌도서관</p>
								<p class="text-02">
									책 읽는 작은 여유가<br/>
									마음 속의<br/>
									큰 행복입니다!
							...
							<ul>
								<li class="qm6">
									<a href="https://www.gbelib.kr/gbelib/index.do" title="통합도서관 새창으로 열립니다." target="_blank">
										<div class="image"><img src="/resources/common/img/main_type01/q1.png" alt=""></div>
										<div class="qtxt">통합도서관</div>
									</a>
								</li>
								<li class="qm1">
									<a href="/${homepage.context_path}/intro/search/loan/index.do?menu_idx=115" title="대출조회·예약">
										<div class="image"><img src="/resources/common/img/main_type01/q2.png" alt=""></div>
										<div class="qtxt">대출조회·예약</div>
									</a>
								</li>
								<li class="qm2">
									<a href="/${homepage.context_path}/intro/search/hope/index.do?menu_idx=158" title="희망도서신청">
										<div class="image"><img src="/resources/common/img/main_type01/q3.png" alt=""></div>
										<div class="qtxt">희망도서신청</div>
									</a>
								</li>
								<li class="qm3">
									<a href="/${homepage.context_path}/html.do?menu_idx=90" title="이용안내">
										<div class="image"><img src="/resources/common/img/main_type01/q4.png" alt=""></div>
										<div class="qtxt">이용안내</div>
									</a>
								</li>
								<li class="qm4">
									<a href="https://www.youth.go.kr/youth/" title="자원봉사신청" target="_blank">
										<div class="image"><img src="/resources/common/img/main_type01/q5.png" alt=""></div>
										<div class="qtxt">자원봉사신청</div>
									</a>
								</li>
								<li class="qm5">
									<a href="/${homepage.context_path}/board/index.do?menu_idx=74&manage_idx=302" title="자주하는질문">
										<div class="image"><img src="/resources/common/img/main_type01/q6.png" alt=""></div>
										<div class="qtxt">자주하는질문</div>
									</a>
								</li>
								<li class="qm7">
									<a href="https://www.gbelib.kr/elib/index.do" title="전자도서관 새창으로 열립니다." target="_blank">
										<div class="image"><img src="/resources/common/img/main_type01/q7.png" alt=""></div>
										<div class="qtxt">전자도서관</div>
									</a>
								</li>
								<li class="qm8">
									<a href="/${homepage.context_path}/html.do?menu_idx=199" title="책이음서비스">
										<div class="image"><img src="/resources/common/img/main_type01/q8.png" alt=""></div>
			...
			<div class="main1_wrap sections">
				<div class="main1-left-box">
					<div class="notice-box">
						<div class="title">
							<h3>공지사항</h3>
							<a href="/${homepage.context_path}/board/index.do?menu_idx=58&manage_idx=198" title="공지사항 더보기 버튼">
		...
		<div id="main2" class="section">
			<div class="main2-wrap mid-sections">
				<div class="calendar-box">
					<div class="title">
						<h3>CALENDAR</h3>
						<a href="/${homepage.context_path}/module/calendarManage/index.do?menu_idx=33" title="일정 더보기 버튼">
				...
				<div class="event-box">
					<div class="title">
						<h3>EVENT</h3>
						<a href="/${homepage.context_path}/module/teach/index.do?menu_idx=190&searchCate1=16,17" title="행사 더보기 버튼">
					...
					<div class="list">
						<ul>
							<c:forEach var="i" items="${teachList}">
								<li>
									<a href="/${homepage.context_path}/module/teach/detail.do?menu_idx=190&searchCate1=${i.large_category_idx}&group_idx=${i.group_idx}&category_idx=${i.category_idx}&teach_idx=${i.teach_idx}&homepage_id=${i.homepage_id}">
										<div>
											<h3>${i.teach_name }</h3>
		...
		<!--도서-->
		<div id="main3" class="section" style="background:none;">
			<div class="main3-wrap sections">				
				<div class="title">
					<ul>
						<li class="on"  keyValue="tab2">
					...
					<ul>
						<li class="qs1">
							<a href="/${homepage.context_path}/html.do?menu_idx=90">
								<div class="outer">
									<div class="inner">
										<div class="image"><img src="/resources/common/img/quick_type01/q1.png" alt="이용안내"></div>
									</div>
								</div>
								<div class="qtxt">이용안내</div>
							</a>
						...
						<li class="qs2">
							<a href="/${homepage.context_path}/intro/search/loan/index.do?menu_idx=115">
								<div class="outer">
									<div class="inner">
										<div class="image"><img src="/resources/common/img/quick_type01/q2.png" alt="대출조회·예약"></div>
									</div>
								</div>
								<div class="qtxt">대출조회·예약</div>
							</a>
						...
						<li class="qs3">
							<a href="/${homepage.context_path}/board/index.do?menu_idx=74&manage_idx=302">
								<div class="outer">
									<div class="inner">
										<div class="image"><img src="/resources/common/img/quick_type01/q3.png" alt="자주하는질문"></div>
									</div>
								</div>
								<div class="qtxt">자주하는질문</div>
							</a>
						...
						<li class="qs4">
							<a href="/${homepage.context_path}/intro/search/hope/index.do?menu_idx=158">
								<div class="outer">
									<div class="inner">
										<div class="image"><img src="/resources/common/img/quick_type01/q4.png" alt="희망도서신청"></div>
									</div>
								</div>
								<div class="qtxt">희망도서신청</div>
							</a>
						...
						<li class="qs5">
							<a href="/${homepage.context_path}/html.do?menu_idx=199">
								<div class="outer">
									<div class="inner">
										<div class="image"><img src="/resources/common/img/quick_type01/q5.png" alt="책이음서비스"></div>
									</div>
								</div>
								<div class="qtxt">책이음서비스</div>
							</a>
					...
					<div class="banner-wrap type6">
						...
						<div class='banner-t6-after'>
							<div class="control">
								...
								<a class="more" href="/${homepage.context_path}/bannermap/index.do?menu_idx=163"><img src="/resources/homepage/gbelib/img/section04/banner-more-btn.png" alt="더보기" /><span class="blind">더보기</span></a>
							</div>
						</div>
					</div>
				</div>
