	...
	<div class="tnb">
		<div class="util-left">
			<ul>
				...
				<li class="gbelib"><a href="https://www.gbelib.kr/gbelib/index.do" target="_blank">통합공공도서관</a></li>
			</ul>
		</div>
		<div class="util-right">
			...
			<c:choose>
				<c:when test="${sessionScope.member.loginType eq 'HOMEPAGE' and sessionScope.member.login}">
					...
					<li><a href="https://www.gbelib.kr/${homepage.context_path}/module/myDashBoard/index.do?menu_idx=73" class='tnb-box-1'>나의도서관</a></li>
				</c:when>
				...
				<c:otherwise>
					<li><a href="https://www.gbelib.kr/${homepage.context_path}/intro/login/index.do?menu_idx=43">로그인</a></li>
					<li><a href="https://www.gbelib.kr/${homepage.context_path}/intro/join/index.do?menu_idx=42">회원가입</a></li>
					<li><a href="https://www.gbelib.kr/${homepage.context_path}/module/myDashBoard/index.do?menu_idx=73" class='tnb-box-1'>나의도서관</a></li>
				</c:otherwise>
			</c:choose>
