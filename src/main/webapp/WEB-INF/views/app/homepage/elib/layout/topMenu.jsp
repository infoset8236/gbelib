...
<div id="m-util">
	<ul>
		<li style="width:49%;"><a href="https://www.info.go.kr/" target="_blank">교육행정포털</a></li>
		<li style="width:49%;"><a href="https://www.gbelib.kr/gbelib/index.do" target="_blank">통합공공도서관</a></li>
		...
		<div class="Gnb">
			...
			<div class="wide-sections">
				...
				<div class="g-menu">
					...
					<a href="/${homepage.context_path}/sitemap/index.do?menu_idx=47" class="last-box-a"><img src="/resources/common/img/sitemap_icon_b.png" alt="사이트맵" class="last-box"></a>

					<div class="mmode">
						<c:choose>
							<c:when test="${sessionScope.member.loginType eq 'HOMEPAGE' and sessionScope.member.login}">
							<a href="/${homepage.context_path}/intro/join/modifyForm.do?menu_idx=48" class="mobilemeberinfo">
							...
							<a href="https://www.gbelib.kr/${homepage.context_path}/html/mobileCard.do?menu_idx=86" class="btn2" style="background:#8008d5;">
							<i class="fa fa-bookmark"></i>
								 <span>모바일회원증</span>
							</a>
