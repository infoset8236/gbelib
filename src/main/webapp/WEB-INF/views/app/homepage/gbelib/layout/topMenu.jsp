...
<div id="m-util">
	<ul>
		...
		<li style="width:100%;"><a href="">모바일회원증</a></li>
	</ul>
</div>
		...
		<div class="Gnb">
			...
			<div class="wide-sections">
				...
				<div class="g-menu">
					...
					<a href="/${homepage.context_path}/sitemap/index.do?menu_idx=141" class="last-box-a"><img src="/resources/common/img/sitemap_icon_b.png" alt="사이트맵" class="last-box"></a>
					...
					<div class="mmode">
						<c:choose>
							...
							<a href="https://www.gbelib.kr/${homepage.context_path}/module/myDashBoard/index.do?menu_idx=154" class="btn4">
								<i class="fa fa-bookmark"></i>
									 <span>나의도서관</span>
							</a>
							<a href="https://www.gbelib.kr/${homepage.context_path}/html/mobileCard.do?menu_idx=163" class="btn2" style="background:#8008d5;">
							<i class="fa fa-bookmark"></i>
								 <span>모바일회원증</span>
							</a>
