		...
		$('#main3 .main3-wrap .title ul li').on('click', function() {
			...
			if (!$(this).hasClass("on")) {
				if (tab == 'tab1') {
					...
					$('#more-link').attr('href', '/${homepage.context_path}/board/index.do?menu_idx=21&manage_idx=151');
					$('#main3 div.list .bookListTop').load('bestBook.do?manage_idx=151&count=10');
				}
					...
					<div class="qmenu" id="mainQmenu">
						<ul>
							<li class="qm1">
									...
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/sjl/img/main/q1.png" data-onsrc="/resources/homepage/sjl/img/main/q1-on.png" data-outsrc="/resources/homepage/sjl/img/main/q1.png" alt="대출조회·예약"></div>
							...
							<li class="qm2">
									<a href="http://www.gbelib.kr/sjl/intro/search/hope/index.do?menu_idx=16" title="희망도서신청">
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/sjl/img/main/q2.png" data-onsrc="/resources/homepage/sjl/img/main/q2-on.png" data-outsrc="/resources/homepage/sjl/img/main/q2.png" alt="희망도서신청"></div>
							...
							<li class="qm3">
									...
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/sjl/img/main/q3.png" data-onsrc="/resources/homepage/sjl/img/main/q3-on.png" data-outsrc="/resources/homepage/sjl/img/main/q3.png" alt="이용안내"></div>
							...
							<li class="qm4">
									<a href="/${homepage.context_path}/module/teach/index.do?menu_idx=46&searchCate1=18&searchAge=11" title="평생교육">
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/sjl/img/main/q4.png" data-onsrc="/resources/homepage/sjl/img/main/q4-on.png" data-outsrc="/resources/homepage/sjl/img/main/q4.png" alt="평생교육"></div>
											<div class="qtxt1">평생교육</div>
											<div class="qtxt2">도서관에서 진행하는 다양한 평생교육 프로그램을 확인해보세요!</div>
											<div class="qtxt3">더보기 <img src="/resources/common/img/main_type02/quick-arrow.png" alt="" /></div>
										</div>
									</div>
								</a>
							...
							<li class="qm5">
								<a href="https://www.gbelib.kr/elib/index.do" title="전자도서관 새창으로 열립니다." target="_blank">
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/sjl/img/main/q5.png" data-onsrc="/resources/homepage/sjl/img/main/q5-on.png" data-outsrc="/resources/homepage/sjl/img/main/q5.png" alt="전자도서관"></div>
			...
			<div class="main1_wrap sections">
				<div class="main1-left-box">
					<div class="notice-box">
						<div class="title">
							<h3>공지사항</h3>
							<a href="/${homepage.context_path}/board/index.do?menu_idx=58&manage_idx=153" title="공지사항 더보기 버튼">
		...
		<div id="main2" class="section">
			<div class="main2-wrap mid-sections">
				<div class="calendar-box">
					<div class="title">
						<h3>일정</h3>
						<a href="/${homepage.context_path}/module/calendarManage/index.do?menu_idx=180" title="일정 더보기 버튼">
				...
				<div class="event-box">
					<div class="title">
						<h3>문화강좌</h3>
						<a href="/${homepage.context_path}/module/teach/index.do?menu_idx=179&searchCate1=16,17" title="행사 더보기 버튼">
					...
					<div class="list">
						<ul>
							<c:forEach var="i" items="${teachList}">
								<li>
									<a href="/${homepage.context_path}/module/teach/detail.do?menu_idx=179&searchCate1=${i.large_category_idx}&group_idx=${i.group_idx}&category_idx=${i.category_idx}&teach_idx=${i.teach_idx}&homepage_id=${i.homepage_id}">
										<div>
											<h3>${i.teach_name }</h3>
