			...
			<div class="sections main0">
				...
				<div class="main0-bottom">
					...
					<div class="qmenu" id="mainQmenu">
						<ul>
							<li class="qm1">
									<a href="https://www.gbelib.kr/sj/intro/search/hope/index.do?menu_idx=16" title="희망도서신청">
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/sj/img/main/q1.png" data-onsrc="/resources/homepage/sj/img/main/q1-on.png" data-outsrc="/resources/homepage/sj/img/main/q1.png" alt="희망도서신청"></div>
							...
							<li class="qm2">
									...
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/sj/img/main/q2.png" data-onsrc="/resources/homepage/sj/img/main/q2-on.png" data-outsrc="/resources/homepage/sj/img/main/q2.png" alt="통합도서관"></div>
							...
							<li class="qm3">
									...
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/sj/img/main/q3.png" data-onsrc="/resources/homepage/sj/img/main/q3-on.png" data-outsrc="/resources/homepage/sj/img/main/q3.png" alt="대출조회·예약"></div>
							...
							<li class="qm4">
									...
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/sj/img/main/q4.png" data-onsrc="/resources/homepage/sj/img/main/q4-on.png" data-outsrc="/resources/homepage/sj/img/main/q4.png" alt="이용안내"></div>
							...
							<li class="qm5">
									...
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/sj/img/main/q5.png" data-onsrc="/resources/homepage/sj/img/main/q5-on.png" data-outsrc="/resources/homepage/sj/img/main/q5.png" alt="전자도서관"></div>
							...
							<li class="qm6">
									<a href="https://zep.us/play/2mPaae" title="메타버스 도서관 새창으로 열립니다." target="_blank">
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/sj/img/main/q6.png" data-onsrc="/resources/homepage/sj/img/main/q6-on.png" data-outsrc="/resources/homepage/sj/img/main/q6.png" alt="전자도서관"></div>
											<div class="qtxt1">메타버스 도서관</div>
											<div class="qtxt2">메타버스 상주도서관을 통해 실제 도서관의 모습, 도서관 행사, 게임 등 다양한 콘텐츠를 볼 수 있습니다!</div>
											<div class="qtxt3">더보기 <img src="/resources/common/img/main_type02/quick-arrow.png" alt="" /></div>
										</div>
									</div>
								</a>
			...
			<div class="main1_wrap sections">
				<div class="main1-left-box">
					<div class="notice-box">
						<div class="title">
							<h3>공지사항</h3>
							<a href="/${homepage.context_path}/board/index.do?menu_idx=58&manage_idx=147" title="공지사항 더보기 버튼">
		...
		<div id="main2" class="section">
			<div class="main2-wrap mid-sections">
				...
				<div class="event-box">
					<div class="title">
						<h3>EVENT</h3>
						<a href="/${homepage.context_path}/module/teach/index.do?menu_idx=189&searchCate1=16,17" title="행사 더보기 버튼">
					...
					<div class="list">
						<ul>
							<c:forEach var="i" items="${teachList}">
								<li>
									<a href="/${homepage.context_path}/module/teach/detail.do?menu_idx=189&searchCate1=${i.large_category_idx}&group_idx=${i.group_idx}&category_idx=${i.category_idx}&teach_idx=${i.teach_idx}&homepage_id=${i.homepage_id}">
										<div>
											<h3>${i.teach_name }</h3>
						...
						<div class="mid-sections">
							<div class="main5-bottom-right">
								<div class="title">
									...
									<a href="/${homepage.context_path}/board/index.do?menu_idx=21&manage_idx=148" class="more"><img src="/resources/common/img/book_type01/book-more-btn.png" alt="더보기" /></a>
								</div>
							</div>
