...
<ul>
	<c:forEach var="i" begin="0" end="4">
		<li class="eventItem" id="newBookImg">
			...
			<span class="thumb">
				<span class="noImg">
					<img src="${newBookList.dsNewBookList[i].COVER_SMALLURL ne '' ? newBookList.dsNewBookList[i].COVER_SMALLURL : '/resources/homepage/geiclib/img/noimg2.png' }" alt="${newBookList.dsNewBookList[i].TITLE}"/>
				</span>
			</span>
			<span class="entry">
				<span>
