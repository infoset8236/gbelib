		...
		$('#main3 .main3-wrap .title ul li').on('click', function() {
			...
			if (!$(this).hasClass("on")) {
				if (tab == 'tab1') {
					...
					$('#more-link').attr('href', '/${homepage.context_path}/board/index.do?menu_idx=21&manage_idx=329');
					$('#main3 div.list .bookListTop').load('bestBook.do?manage_idx=329&count=10');
				}
		...
		<div id="main0" class="section">
			<div class="main-visual">
				...
				<div class="sections middle">
					<img src="/resources/homepage/uj/img/main/visual-bg.jpg" alt="">
				</div>
			...
			<div class="main1_wrap mid-sections">
				<div class="main1-left-box">
					<div class="notice-box">
						<div class="title">
							<h3>공지사항</h3>
							<a href="/${homepage.context_path}/board/index.do?menu_idx=58&manage_idx=342" title="공지사항 더보기 버튼">
