...
<div id="m-util" class="no4">
	<ul>
		...
		<li><a href="https://zep.us/play/2RE0vJ" target="_blank">칠곡도서관 메타버스</a></li>
				...
				<div class="g-menu">
					...
					<div class="mmode">
						<c:choose>
							...
							<a href="https://www.gbelib.kr/${homepage.context_path}/module/myDashBoard/index.do?menu_idx=180" class="btn4">
