			...
			<div class="sections">
				...
				<div class="info-right">
					<div class="site_link">
						...
						<div class="sns">
							<a href="https://books.nl.go.kr/" target="_blank"><img src="/resources/homepage/${homepage.context_path}/img/foot-link-icon01.png" onmouseover="this.src='/resources/homepage/${homepage.context_path}/img/foot-link-icon01-on.png'" onmouseout="this.src='/resources/homepage/${homepage.context_path}/img/foot-link-icon01.png'" alt="책바다 홈페이지 바로가기(새창열림)"/></a>
							<a href="https://cn.nld.go.kr/index.do" target="_blank"><img src="/resources/homepage/${homepage.context_path}/img/foot-link-icon02.png" onmouseover="this.src='/resources/homepage/${homepage.context_path}/img/foot-link-icon02-on.png'" onmouseout="this.src='/resources/homepage/${homepage.context_path}/img/foot-link-icon02.png'" alt="책나래 홈페이지 바로가기(새창열림)"/></a>
							<a href="https://www.nl.go.kr/NL/contents/N30502000000.do" target="_blank"><img src="/resources/homepage/${homepage.context_path}/img/foot-link-icon03.png" onmouseover="this.src='/resources/homepage/${homepage.context_path}/img/foot-link-icon03-on.png'" onmouseout="this.src='/resources/homepage/${homepage.context_path}/img/foot-link-icon03.png'" alt="사서에게물어보세요 홈페이지 바로가기(새창열림)"/></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="sections">
				<div class="">
					...
					<div class="info">
						...
						<a href="/${homepage.context_path}/html.do?menu_idx=150" style="color: yellow;">개인정보처리방침</a>
						<span class="txt-menu-bar"></span>
						<a href="/${homepage.context_path}/html.do?menu_idx=151">영상정보처리기기운영관리방침</a>
						<span class="txt-menu-bar"></span>
