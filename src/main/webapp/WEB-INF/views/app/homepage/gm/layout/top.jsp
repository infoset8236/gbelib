	...
	<div class="tnb">
		<div class="util-left">
			<ul>
				...
				<li class="meta-banner"><a href="https://zep.us/@gumilib" target="_blank">구미도서관 메타버스</a></li>
			</ul>
		</div>
		<div class="util-right">
			...
			<c:choose>
				<c:when test="${sessionScope.member.loginType eq 'HOMEPAGE' and sessionScope.member.login}">
					...
					<li><a href="https://www.gbelib.kr/${homepage.context_path}/module/myDashBoard/index.do?menu_idx=191" class='tnb-box-1'>나의도서관</a></li>
				</c:when>
