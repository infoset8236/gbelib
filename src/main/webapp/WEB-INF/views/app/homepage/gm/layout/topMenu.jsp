...
<div id="m-util" class="no3">
	<ul>
		...
		<li><a href="https://zep.us/@gumilib" target="_blank">구미도서관 메타버스</a></li>
				...
				<div class="g-menu">
					...
					<div class="mmode">
						<c:choose>
							...
							<a href="https://www.gbelib.kr/${homepage.context_path}/module/myDashBoard/index.do?menu_idx=191" class="btn4">
           						<i class="fa fa-bookmark"></i>
          							 <span>나의도서관</span>
       						  </a>
							<a href="https://www.gbelib.kr/${homepage.context_path}/html/mobileCard.do?menu_idx=260" class="btn2" style="background:#8008d5;">
							<i class="fa fa-bookmark"></i>
								 <span>모바일회원증</span>
							</a>
