			...
			<div class="sections main0">
				...
				<div class="main0-bottom">
					...
					<div class="qmenu" id="mainQmenu">
						<ul>
							<li class="qm1">
								<a href="http://www.gbelib.kr/gm/intro/search/hope/index.do?menu_idx=16" title="희망도서신청">
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/gm/img/main/q1.png" data-onsrc="/resources/homepage/gm/img/main/q1-on.png" data-outsrc="/resources/homepage/gm/img/main/q1.png" alt="희망도서신청"></div>
							...
							<li class="qm2">
								<a href="https://www.gbelib.kr/gbelib/index.do" title="통합도서관 새창으로 열립니다." target="_blank">
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/gm/img/main/q2.png" data-onsrc="/resources/homepage/gm/img/main/q2-on.png" data-outsrc="/resources/homepage/gm/img/main/q2.png" alt="통합도서관"></div>
							...
							<li class="qm3">
								<a href="/${homepage.context_path}/intro/search/loan/index.do?menu_idx=115" title="대출조회·예약">
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/gm/img/main/q3.png" data-onsrc="/resources/homepage/gm/img/main/q3-on.png" data-outsrc="/resources/homepage/gm/img/main/q3.png" alt="대출조회·예약"></div>
							...
							<li class="qm4">
								<a href="/${homepage.context_path}/html.do?menu_idx=90" title="이용안내">
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/gm/img/main/q4.png" data-onsrc="/resources/homepage/gm/img/main/q4-on.png" data-outsrc="/resources/homepage/gm/img/main/q4.png" alt="이용안내"></div>
											<div class="qtxt1">이용안내</div>
											<div class="qtxt2">도서관 열람실, 대출 및 반납등에 대한 안내를 상세히 확인할 수 있습니다.</div>
											<div class="qtxt3">더보기 <img src="/resources/common/img/main_type02/quick-arrow.png" alt="" /></div>
										</div>
									</div>
								</a>
							...
							<li class="qm5">
								<a href="https://www.gbelib.kr/elib/index.do" title="전자도서관 새창으로 열립니다." target="_blank">
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/gm/img/main/q5.png" data-onsrc="/resources/homepage/gm/img/main/q5-on.png" data-outsrc="/resources/homepage/gm/img/main/q5.png" alt="전자도서관"></div>
							...
							<li class="qm6">
								<a href="https://zep.us/play/8gkY55" title="메타버스 도서관 새창으로 열립니다." target="_blank">
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/gm/img/main/q6.png" data-onsrc="/resources/homepage/gm/img/main/q6-on.png" data-outsrc="/resources/homepage/gm/img/main/q6.png" alt="메타버스 도서관"></div>
											<div class="qtxt1">메타버스 도서관</div>
											<div class="qtxt2">구미도서관 메타버스를 통해 실제 도서관의 모습, 도서관 행사, 게임 등 다양한 콘텐츠를 볼 수 있습니다!</div>
											<div class="qtxt3">더보기 <img src="/resources/common/img/main_type02/quick-arrow.png" alt="" /></div>
										</div>
									</div>
								</a>
							...
							<li class="qm7">
								<a href="https://gbelib.kr/gm/smartExperience.jsp" title="스마트 체험 도서관 페이지로 이동합니다.">
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/gm/img/main/q7.png" data-onsrc="/resources/homepage/gm/img/main/q7-on.png" data-outsrc="/resources/homepage/gm/img/main/q7.png" alt="스마트 체험 도서관"></div>
											<div class="qtxt1">스마트 체험 도서관</div>
											<div class="qtxt2">멀티미디어영상, 애니메이션 등 다양한 매체와 연계도서 활용을 통한 융합독서체험을 즐겨보세요!</div>
											<div class="qtxt3">더보기 <img src="/resources/common/img/main_type02/quick-arrow.png" alt="" /></div>
										</div>
									</div>
								</a>
			...
			<div class="main1_wrap sections">
				<div class="main1-left-box">
					<div class="notice-box">
						<div class="title">
							<h3>공지사항</h3>
							<a href="/${homepage.context_path}/board/index.do?menu_idx=58&manage_idx=132" title="공지사항 더보기 버튼">
				...
				<div class="main1-right-box">
					<div class="popupzonenew">
						...
						<c:choose>
							...
							<c:otherwise>
								<ul>
									<li><a href="javascript:void(0);"><img src="/resources/common/img/popupnone02.jpg" alt="" /></a></li>
								</ul>
							</c:otherwise>
						</c:choose>
					</div>
		...
		<div id="main2" class="section">
			<div class="main2-wrap mid-sections">
				...
				<div class="event-box">
					<div class="title">
						<h3>EVENT</h3>
						<a href="/${homepage.context_path}/module/teach/index.do?menu_idx=174&searchCate1=16,17" title="행사 더보기 버튼">
					...
					<div class="list">
						<ul>
							<c:forEach var="i" items="${teachList}">
								<li>
									<a href="/${homepage.context_path}/module/teach/detail.do?menu_idx=174&searchCate1=${i.large_category_idx}&group_idx=${i.group_idx}&category_idx=${i.category_idx}&teach_idx=${i.teach_idx}&homepage_id=${i.homepage_id}">
										<div>
											<h3>${i.teach_name }</h3>
					...
					<div class="main5-top">
						<div class="mid-sections">
							...
							<div class="main5-top-right">
								<div class="outer">
									<div class="inner">
										<div class="bookListTop" id="newbook">
											<ul>
					...
					<div class="main5-bottom">
						<div class="mid-sections">
							<div class="main5-bottom-right">
								<div class="title">
									<h2><div class='stxt'>THEMA BOOK</div><div class='ltxt'>테마도서</div></h2>
									<a href="/${homepage.context_path}/board/index.do?menu_idx=24&manage_idx=313" class="more"><img src="/resources/common/img/book_type01/book-more-btn.png" alt="더보기" /></a>
								</div>
							</div>
										...
										<div class="bookListBottom">
											<ul>
												<c:forEach items="${bookList}" var="i">
													<li class="item">
														<a href="/${homepage.context_path}/board/view.do?menu_idx=24&manage_idx=${i.manage_idx}&board_idx=${i.board_idx}">
															<div class="">
																<c:choose>
					...
					<div class="banner-wrap type6">
						...
						<div class='banner-t6-after'>
							<div class="control">
								...
								<a class="more" href="/${homepage.context_path}/bannermap/index.do?menu_idx=151"><img src="/resources/homepage/gbelib/img/section04/banner-more-btn.png" alt="더보기" /><span class="blind">더보기</span></a>
							</div>
						</div>
					</div>
				</div>
