...
<style>
	.calendar-info{position:absolute;bottom:15px;right:20px;padding:0 !important;}
	.calendar-info span{font-size:13px;color:#767676;padding-left:10px;margin-left:5px;font-weight:500;}
	.calendar-info span.hu{background:url('/resources/common/img/culture_type02/cal-close-dot.png') no-repeat 0 7px !important;margin-right:0 !important;}
	.calendar-info span.ev{background:url('/resources/common/img/culture_type02/cal-event-dot.png') no-repeat 0 7px !important;}
</style>
<div id="calendar2">
