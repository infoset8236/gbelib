...
<div id="m-util" class="no5">
	<ul>
		...
		<li><a href="https://www.gbelib.kr/yjpg/index.do" target="_blank">풍기분관</a></li>
		<li><a href="https://www.instagram.com/gbelib_yj/" target="_blank">인스타그램</a></li>
				...
				<div class="g-menu">
					...
					<div class="mmode">
						<c:choose>
							...
							<a href="https://www.gbelib.kr/${homepage.context_path}/html/mobileCard.do?menu_idx=233" class="btn2" style="background:#8008d5;">
							<i class="fa fa-bookmark"></i>
								 <span>모바일회원증</span>
							</a>
