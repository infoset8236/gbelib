...
<form:form id="bookListForm" modelAttribute="hopeElibBook" action="hopeElibSearch.do" method="GET" autocomplete="off">
	<div id="searchBox">
		...
		<div class="txt-box">
			<ul class="con">
				<li>월별 1인당 최대 2권까지 신청하실 수 있습니다.</li>
				<li>일반도서과 달리 출판사에서 일반 개인소비자(B2C)와 도서관과 같은 기관(B2B)에 납품되는 전자책을 구분하여 운영 중이므로, 모든 희망 전자책를 구입할 수 없는 점 양해 부탁드립니다.</li>
				<li>희망 전자책 구입 후 신청 이용자에게 별도의 알림 및 우선 대출은 되지 않으며, 최대 5명까지 대출 가능합니다.</li>
				<li>누리집 공지 사항을 통해 희망전자책 구입여부를 확인 하실 수 있습니다.</li>
			</ul>
		</div>
		<br/>
