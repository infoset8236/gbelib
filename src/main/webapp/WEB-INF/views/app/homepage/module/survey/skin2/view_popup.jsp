...
<link href="/resources/cms/survey/css/selectbox.css" rel="stylesheet" type="text/css">
	...
	<div id="wrap">
		...
		<div class="brdTop_02">
			<div class="survey_info_wrap">
				...
				<p class="contact">
				<img src="/resources/cms/survey/img/ico_question.gif" alt="문의"/>
<%-- 				<span><strong>조사문의:</strong> 담당자 ( ${survey.add_user_tel} )  </span></p> --%>
			</div>
		</div>
<!--// 상단 -->
