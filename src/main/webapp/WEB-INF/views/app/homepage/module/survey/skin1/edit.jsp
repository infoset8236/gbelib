...
<link rel="stylesheet" type="text/css" href="/resources/cms/survey/css/skin1.css"/>
<script>
...
<div class="button bbs-btn center">
	<c:if test="${quest.open_yn eq 'Y' and quest.survey_open_yn eq 'N'}">
		<c:if test="${homepage.homepage_id ne 'h24'}">
			<a href="" class="btn btn3 statistics" id="board_print_btn"><i class="fa fa-bar-chart"></i><span>통계보기</span></a>
		</c:if>
	</c:if>
	<c:if test="${survey.survey_open_yn eq 'Y' and !already}">
	<a href="" class="btn btn2 save" id="board_print_btn"><i class="fa fa-pencil"></i><span>설문완료</span></a>	
	</c:if>
