...
<h2>새 책 드림 서비스 안내</h2>
<p class="guide_box">안동도서관은 새 책 드림 서비스를 통해 지역사회가 좋은 책을 서로 권하고 함께 읽는 독서나눔문화를 꽃피우길 바랍니다.</p>
...
<div id="guide">
	...
	<img src="/resources/homepage/bookdream/img/guide_list.png" alt="안동도서관 홈페이지에서 책 검색을 한 후 읽고 싶은 책이 없다면 협약 서점에 가서 책을 구입합니다. 책 구입 후 15일 내에 도서관에 책을 반납하면 판매서점에서 도서 구입금액을 전액 환불합니다.">
