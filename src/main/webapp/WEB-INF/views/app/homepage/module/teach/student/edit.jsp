...
$(function() {
	...
	$('#save-btn').on('click', function() {
		...
		if (doAjaxPost($form)) {
			doGetLoad('/${homepage.context_path}/module/teach/index.do', 'group_idx='+$('input#group_idx').val()+'&menu_idx='+$('input#menu_idx').val() +'&searchCate1='+$('input#large_category_idx').val());
		}
	});
