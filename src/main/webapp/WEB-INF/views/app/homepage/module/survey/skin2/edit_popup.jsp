...
<link href="/resources/cms/survey/css/type2.css" rel="stylesheet" type="text/css">
		...
		<div class="surveyList">
			<table class="list" summary="설문조사 문항에 대한 답변을 작성할 수 있습니다.">
				...
				<c:when test="${i.quest_type eq 'IMAGE'}">
					<tr>
						<td><span>&nbsp;</span></td>
						<td class="qustion"><img alt="noImage" src="${getContextPath}${i.quest_content}" style="max-width: 730px;"/ ></td>
					</tr>
				</c:when>
				</c:choose>
				</c:forEach>
