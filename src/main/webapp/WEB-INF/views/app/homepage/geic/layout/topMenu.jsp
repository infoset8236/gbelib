		...
		<div class="Gnb">
			...
			<div class="wide-sections">
				...
				<div class="g-menu">
					...
					<a href="/${homepage.context_path}/sitemap/index.do?menu_idx=110" class="last-box-a"><img src="/resources/common/img/sitemap_icon_b.png" alt="사이트맵" class="last-box"></a>

					<div class="mmode">
						<c:choose>
							<c:when test="${sessionScope.member.loginType eq 'HOMEPAGE' and sessionScope.member.login}">
							<a href="/${homepage.context_path}/intro/join/modifyForm.do?menu_idx=88" class="mobilemeberinfo">
								<i class="fa fa-user"></i>
									<span>${sessionScope.member.member_name}님</span>
							</a>
							<a href="https://www.gbelib.kr/${homepage.context_path}/module/myDashBoard/index.do?menu_idx=219" class="btn4">
							<i class="fa fa-bookmark"></i>
								 <span>나의도서관</span>
							</a>
							<a href="https://www.gbelib.kr/${homepage.context_path}/html/mobileCard.do?menu_idx=317" class="btn2" style="background:#8008d5;">
							<i class="fa fa-bookmark"></i>
								 <span>모바일회원증</span>
							</a>
							...
							<c:otherwise>
								<a href="https://www.gbelib.kr/${homepage.context_path}/intro/login/index.do?menu_idx=96" class="btn1">
