...
<ul>
	<c:forEach items="${galleryList}" var="i">
		<li>
			<a href="/${homepage.context_path}/board/view.do?menu_idx=101&manage_idx=${i.manage_idx}&board_idx=${i.board_idx}" title="도서 자세히 보기">
				<div class="img-box">
					<c:choose>
						...
						<c:otherwise>
							<img src="/data/board/${i.manage_idx}/${i.board_idx}/${i.preview_img}" alt="${i.title}" title="${i.title}" onerror="this.src='/resources/homepage/gm/img/noimg1.png'" style="width: 436px;"/>
						</c:otherwise>
					</c:choose>
				</div>
				<div class="txt-box">
