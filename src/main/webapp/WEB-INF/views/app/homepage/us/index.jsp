...
<script type="text/javascript">
	$(function() {
		...
		resizeFunc();
	   	...
	   	$('div#calendar').load('calendar2.do');
	   	...
	   	doAjaxLoad('li#like_book2_1', 'newBook.do','');
		...
		$('#main3 .main3-wrap .title ul li').on('click', function() {
			...
			if (!$(this).hasClass("on")) {
				if (tab == 'tab1') {
					...
					$('#more-link').attr('href', '/${homepage.context_path}/board/index.do?menu_idx=21&manage_idx=484');
					$('#main3 div.list .bookListTop').load('bestBook.do?manage_idx=484&count=10');
				} else if(tab == 'tab3') {
					$('#more-link').attr('href', '/${homepage.context_path}/board/index.do?menu_idx=101&manage_idx=488');
					$('#main3 div.list .bookListTop').load('galleryList.do?manage_idx=488&count=10');
				}
		...
		<div id="main0" class="section">
			<div class="main-visual">
				<div class="main-txt-area">
					<div class="main-txt">
						<div class="txt-wrap"><span class="txt01">당신의 <b>꿈</b>과<br class="web-br"/> <b>행복</b>이 함께하는 곳</span><br/> <span class="txt02">경상북도교육청 의성도서관입니다</span></div> 
					</div>
				</div>
					...
					<div class="main-box">
						<div class="qmenu">
							<ul>
								...
								<li class="qm6">
									<a href="/${homepage.context_path}/board/index.do?menu_idx=74&manage_idx=486" title="자주하는질문">
			...
			<div class="main1_wrap mid-sections">
				<div class="main1-left-box">
					<div class="notice-box">
						<div class="title">
							<h3>공지사항</h3>
							<a href="/${homepage.context_path}/board/index.do?menu_idx=58&manage_idx=496" title="공지사항 더보기 버튼">
								<img src="/resources/common/img/notice_type03/more-btn.png" alt="공지사항 더보기 이미지" title="공지사항 더보기 이미지">
							</a>
						</div>
						<div class="list">
							<ul>
				...
				<div class="main1-right-box">
					...
					<div class="popupzonenew">
						<c:choose>
							...
							<c:otherwise>
								<ul>
									<li><a href="javascript:void(0);"><img src="/resources/common/img/notice_type03/popupnone.png" alt="" /></a></li>
								</ul>
							</c:otherwise>
						</c:choose>
					</div>
		...
		<div id="main2" class="section">
			<div class="main2-wrap mid-sections">
				...
				<div class="event-box">
					<div class="title">
						<h3>EVENT</h3>
						<a href="/${homepage.context_path}/module/teach/index.do?menu_idx=151&searchCate1=16,17" title="행사 더보기 버튼">
					...
					<div class="list">
						<ul>
							<c:forEach var="i" items="${teachList}">
								<li>
									<a href="/${homepage.context_path}/module/teach/detail.do?menu_idx=151&searchCate1=${i.large_category_idx}&group_idx=${i.group_idx}&category_idx=${i.category_idx}&teach_idx=${i.teach_idx}&homepage_id=${i.homepage_id}">
										<div>
											<h3>${i.teach_name }</h3>
			...
			<div class="main3-wrap sections">				
				<div class="title">
					<ul>
						...
						<li keyValue="tab3">
							<a href="javascript:void(0);" title="사진으로보는도서관 보기" >
								사진으로보는도서관
							</a>
						</li>
					</ul>
					...
					<div class="banner-wrap type6">
						...
						<div class='banner-t6-after'>
							<div class="control">
								...
								<a class="more" href="/${homepage.context_path}/bannermap/index.do?menu_idx=164"><img src="/resources/homepage/gbelib/img/section04/banner-more-btn.png" alt="더보기" /><span class="blind">더보기</span></a>
							</div>
						</div>
					</div>
				</div>
