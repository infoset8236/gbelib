		...
		<div class="bottom-box">
			<div class="sections">
				<div class="">
					...
					<div class="info">
						<a href="/${homepage.context_path}/html.do?menu_idx=192">도서관이용규정</a>
						<span class="txt-menu-bar"></span>
						<a href="/${homepage.context_path}/html.do?menu_idx=190" style="color: yellow;">개인정보처리방침</a>
						<span class="txt-menu-bar"></span>
						<a href="/${homepage.context_path}/html.do?menu_idx=191">영상정보처리기기운영관리방침</a>
						<span class="txt-menu-bar"></span>
						<a href="/${homepage.context_path}/html.do?menu_idx=189">도서관서비스헌장</a>
						<span class="txt-menu-bar"></span>
						<a href="/${homepage.context_path}/html.do?menu_idx=164">찾아오시는길</a>
					</div>
					</div>
