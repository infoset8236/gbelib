	...
	<script type="text/javascript">
		$(function() {
			...
			$('#main3 .main3-wrap .title ul li').on('click', function() {
				...
				if (!$(this).hasClass("on")) {
					$('#main3 div.list .bookListTop').empty;
					if (tab == 'tab1') {
						$('#more-link').attr('href', '/${homepage.context_path}/intro/search/newBook/index.do?menu_idx=12');
						$('#main3 div.list .bookListTop').load('newBook.do');
					} else {
						$('#more-link').attr('href', '/${homepage.context_path}/board/index.do?menu_idx=13&manage_idx=402');
						$('#main3 div.list .bookListTop').load('bestBook.do?manage_idx=402&count=10');
					}
				...
				<div class="main0-top">
					<div class="sections main0">
						<div class="main0-inner-left">
							<div class="main-txt">
								<p class="txt01"><span class="">GYEONGSANGBUKDO LIBRARY</span></p>
				...
				<div class="sections">
					...
					<div class="qmenu">
						<ul>
							...
							<li class="qm3">
								<a href="/${homepage.context_path}/board/index.do?menu_idx=74&manage_idx=406">
			...
			<div class="main2-bottom">
				<div class="sections">
					<div class="news-box">
						<div class="list">
							<ul>
								<c:forEach var="i" items="${noticeList}">
									<li>
										<a href="/${homepage.context_path}/board/view.do?menu_idx=58&amp;manage_idx=${i.manage_idx}&amp;board_idx=${i.board_idx}" title="공지사항 게시글 자세히보기">
											<p>${i.title}</p>
						...
						<div class="line"></div>
						<div class="title">
							<a href="/${homepage.context_path}/board/index.do?menu_idx=58&manage_idx=400" title="공지사항 더보기">공지사항</a>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="sections">
						<div class="outer">
							<div class="inner">
								<div class="title">
									<h2>EVENT</h2>
									<a href="/${homepage.context_path}/module/teach/index.do?menu_idx=180&searchCate1=16,17" class="more">MORE <img src="/resources/common/img/culture_type01/notice-view-btn.png" alt="더보기"></a>
								</div>
								<script>
									$(function(){
								...
								<div class="cultureList">
									<ul>
										...
										<li>
											<a href="/${homepage.context_path}/module/teach/detail.do?menu_idx=180&searchCate1=${i.large_category_idx}&group_idx=${i.group_idx}&category_idx=${i.category_idx}&teach_idx=${i.teach_idx}&homepage_id=${i.homepage_id}">
												<div class="">
