	...
	<div class="tnb">
		<div class="util-left">
			<ul>
				...
				<a href="https://nsmart.koedu.co.kr/library.php?chk=Y2hrdGltZT0xNDQ0Nzc1ODE4JmxpYnJhcnk97JWI64%2BZ64%2BE7ISc6rSAIO2SjeyCsOu2hOq0gCZ1YXNlcl9uYW1lPeyViOuPmeuPhOyEnOq0gCDtko3sgrDrtoTqtIAmdWFzZXJfaWQ9YWRwczAwMg%3D%3D" target="_blank">스마트체험도서관</a>
				</c:when>
				<c:otherwise>
				<a href="javascript:alert('로그인 후 이용 바랍니다.'); location.href='/adps/intro/login/index.do?menu_idx=121';">스마트체험도서관</a>
				</c:otherwise>
				</c:choose>
				</li>
			</ul>
		...
		<div class="util-right">
			...
			<c:choose>
				<c:when test="${sessionScope.member.loginType eq 'HOMEPAGE' and sessionScope.member.login}">
					...
					<li><a href="https://www.gbelib.kr/${homepage.context_path}/module/myDashBoard/index.do?menu_idx=194" class='tnb-box-1'>나의도서관</a></li>
				</c:when>
