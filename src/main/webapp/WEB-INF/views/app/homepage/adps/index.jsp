		...
		$('#main3 .main3-wrap .title ul li').on('click', function() {
			...
			if (!$(this).hasClass("on")) {
				if (tab == 'tab1') {
					...
					$('#more-link').attr('href', '/${homepage.context_path}/board/index.do?menu_idx=24&manage_idx=430');
					$('#main3 div.list .bookListTop').load('bestBook.do?manage_idx=430&count=10');
				}
			...
			<div class="sections main0">
				...
				<div class="main0-bottom">
					<div class="qmenu" id="mainQmenu">
						<ul>
							<li class="qm1">
									<a href="/${homepage.context_path}/html.do?menu_idx=90" title="도서관이용안내">
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/adps/img/main/q1.png" data-onsrc="/resources/homepage/adps/img/main/q1-on.png" data-outsrc="/resources/homepage/adps/img/main/q1.png" alt="도서관이용안내"></div>
											<div class="qtxt1">도서관이용안내</div>
											<div class="qtxt2">안동도서관풍산분관 이용방법에 대해서 자세하게 안내드립니다!</div>
							...
							<li class="qm2">
									...
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/adps/img/main/q2.png" data-onsrc="/resources/homepage/adps/img/main/q2-on.png" data-outsrc="/resources/homepage/adps/img/main/q2.png" alt="희망도서신청"></div>
							...
							<li class="qm3">
									...
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/adps/img/main/q3.png" data-onsrc="/resources/homepage/adps/img/main/q3-on.png" data-outsrc="/resources/homepage/adps/img/main/q3.png" alt="대출조회·예약"></div>
							...
							<li class="qm4">
									<a href="/${homepage.context_path}/module/teach/index.do?menu_idx=180&searchCate1=18" title="평생교육강좌안내">
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/adps/img/main/q4.png" data-onsrc="/resources/homepage/adps/img/main/q4-on.png" data-outsrc="/resources/homepage/adps/img/main/q4.png" alt="평생교육강좌안내"></div>
											<div class="qtxt1">평생교육강좌안내</div>
											<div class="qtxt2">다양한 평생교육강좌를 통해서 책과 더욱 친해져보세요! </div>
											<div class="qtxt3">더보기 <img src="/resources/common/img/main_type02/quick-arrow.png" alt="" /></div>
										</div>
									</div>
								</a>
							...
							<li class="qm5">
									...
									<div class="outer">
										<div class="inner">
											<div class="image"><img src="/resources/homepage/adps/img/main/q5.png" data-onsrc="/resources/homepage/adps/img/main/q5-on.png" data-outsrc="/resources/homepage/adps/img/main/q5.png" alt="전자도서관"></div>
			...
			<div class="main1_wrap sections">
				<div class="main1-left-box">
					<div class="notice-box">
						<div class="title">
							<h3>공지사항</h3>
							<a href="/${homepage.context_path}/board/index.do?menu_idx=58&manage_idx=421" title="공지사항 더보기 버튼">
						...
						<div class="list">
							<ul>
								...
								<c:if test="${empty noticeList}">
									<li>
										<a href="javascript:void(0)" title="등록된 공지사항이 없습니다.">
											<p>등록된 공지사항이 없습니다.</p>
										</a>
									</li>
								</c:if>
...
<!-- 						</li> -->
					...
					<div class="more-btn">
						<a href="/${homepage.context_path}/intro/search/newBook/index.do?menu_idx=12" title="도서 목록 보기" id="more-link">
							<img src="/resources/common/img/book_type02/book-more-btn-w.png" alt="도서목록 더보기 이미지" title="도서목록 더보기 이미지">
						</a>
					</div>
				</div>
					...
					<div class="banner-wrap type6">
						...
						<div class='banner-t6-after'>
							<div class="control">
								...
								<a class="more" href="/${homepage.context_path}/bannermap/index.do?menu_idx=171"><img src="/resources/homepage/gbelib/img/section04/banner-more-btn.png" alt="더보기" /><span class="blind">더보기</span></a>
							</div>
						</div>
					</div>
				</div>
