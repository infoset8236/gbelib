...
<div id="calendar2">
	<div class="calendar-wrap">
		<div class="cal-bord">
			<div class="cal-func2">
				<a id="before-btn" href="#prev" class="btn prev" keyvalue="${calendar.plan_date}"><img src="/resources/common/img/culture_type03/cal-prev-btn.png" alt="이전달"><span class="blind">이전달</span></a>
				<p>${fn:split(calendar.plan_date, '-')[0]}</p>
				<b>${fn:split(calendar.plan_date, '-')[1]}</b>
				<a id="next-btn" href="#next" class="btn next" keyvalue="${calendar.plan_date}"><img src="/resources/common/img/culture_type03/cal-next-btn.png" alt="다음달"><span class="blind">다음달</span></a>
			</div>
										...
										<c:otherwise>
											...
											<c:choose>
												<c:when test="${fn:indexOf(closeDayList.dd, one) > -1 }">
													<span class="hu showCal" keyValue="${i.sun}">${i.sun}</span>
												</c:when>
												<c:otherwise>
													<span class="ev showCal" keyValue="${i.sun}">${i.sun}</span>
												</c:otherwise>
											</c:choose>
										</c:otherwise>
									</c:choose>
								...
								<div>
									<c:choose>
										...
										<c:otherwise>
											...
											<c:choose>
												<c:when test="${fn:indexOf(closeDayList.dd, one) > -1 }">
													<span class="hu showCal" keyValue="${i.mon}">${i.mon}</span>
												</c:when>
												<c:otherwise>
													<span class="ev showCal" keyValue="${i.mon}">${i.mon}</span>
												</c:otherwise>
											</c:choose>
										</c:otherwise>
									</c:choose>
								...
								<div>
									<c:choose>
										...
										<c:otherwise>
											...
											<c:choose>
												<c:when test="${fn:indexOf(closeDayList.dd, one) > -1 }">
													<span class="hu showCal" keyValue="${i.tue}">${i.tue}</span>
												</c:when>
												<c:otherwise>
													<span class="ev showCal" keyValue="${i.tue}">${i.tue}</span>
												</c:otherwise>
											</c:choose>
										</c:otherwise>
									</c:choose>
								...
								<div>
									<c:choose>
										...
										<c:otherwise>
											...
											<c:choose>
												<c:when test="${fn:indexOf(closeDayList.dd, one) > -1 }">
													<span class="hu showCal" keyValue="${i.wed}">${i.wed}</span>
												</c:when>
												<c:otherwise>
													<span class="ev showCal" keyValue="${i.wed}">${i.wed}</span>
												</c:otherwise>
											</c:choose>
										</c:otherwise>
									</c:choose>
								...
								<div>
									<c:choose>
										...
										<c:otherwise>
											...
											<c:choose>
												<c:when test="${fn:indexOf(closeDayList.dd, one) > -1 }">
													<span class="hu showCal" keyValue="${i.thu}">${i.thu}</span>
												</c:when>
												<c:otherwise>
													<span class="ev showCal" keyValue="${i.thu}">${i.thu}</span>
												</c:otherwise>
											</c:choose>
										</c:otherwise>
									</c:choose>
								...
								<div>
									<c:choose>
										...
										<c:otherwise>
											...
											<c:choose>
												<c:when test="${fn:indexOf(closeDayList.dd, one) > -1 }">
													<span class="hu showCal" keyValue="${i.fri}">${i.fri}</span>
												</c:when>
												<c:otherwise>
													<span class="ev showCal" keyValue="${i.fri}">${i.fri}</span>
												</c:otherwise>
											</c:choose>
										</c:otherwise>
									</c:choose>
								...
								<div>
									<c:choose>
										...
										<c:otherwise>
											...
											<c:choose>
												<c:when test="${fn:indexOf(closeDayList.dd, one) > -1 }">
													<span class="hu showCal" keyValue="${i.sat}">${i.sat}</span>
												</c:when>
												<c:otherwise>
													<span class="ev showCal" keyValue="${i.sat}">${i.sat}</span>
												</c:otherwise>
											</c:choose>
										</c:otherwise>
									</c:choose>
