			...
			<div class="main-visual">
				...
				<div class="swiper-container mySwiper">
					<div class="swiper-wrapper">
						<div class="swiper-slide mvimg01"><div class="mvText"><p class="main_text"><b>가은이네 도서관,</b> 당신이 주인입니다.</p></div></div>
						<div class="swiper-slide mvimg02"><div class="mvText"><p class="main_text"><b>가은이네 도서관,</b> 당신이 주인입니다.</p></div></div>
					</div>
				</div>
		...
		<div class="section" id="main1">
			<div class='main-section'>
				<div class="notice-box">
					...
					<h3>공지사항</h3>
					<a href="/${homepage.context_path}/board/index.do?menu_idx=36&manage_idx=767" class="big_txt_more">더보기</a>
					<div class="news con">
						<div class="box">
							...
							<ul>
								...
								<li>
									<div>
										<a href="/${homepage.context_path}/board/view.do?menu_idx=36&manage_idx=767&board_idx=${i.board_idx}">
			...
			<div class='main-section'>
				...
				<div class="curation-box">
					<div class="curation-section">
									...
									<div class="book-list-section">
										<div>
											<ul class="rolling01">
												<li>
													<div class="thumbnail">
													<a href="javascript:void(0);" target="_blank"><img src="http://q.gbelib.kr/CATE_IMG/79/99E7B179-B60F-7951-B946-38C4636C02E8.png" alt="6월 추천도서 안내 "></a>
													</div>
													<div class="contents">
														<h3 class="book-title"><a href="javascript:void(0);" target="_blank">6월 추천도서 안내</a></h3>
									...
									<div class="book-list-section">
										<div>
											<ul class="rolling01">
												<li>
												<div class="thumbnail">
													<a href="javascript:void(0);" target="_blank"><img src="http://q.gbelib.kr/CATE_IMG/79/9991A0FC-540E-2EB9-CE9C-30B4862A40ED.png" alt="이달의 전자도서관 퀴즈왕! 독서퀴즈 이벤트"></a>
												</div>
												<div class="contents">
													<h3 class="book-title"><a href="javascript:void(0);" target="_blank">이달의 전자도서관 퀴즈왕! 독서퀴즈 이벤트</a></h3>
								...
								<div class="col-sm-3">
									<div class="book-list-section">
										<div>
											...
											<li>
												<div class="thumbnail">
													<a href="javascript:void(0);" target="_blank"><img src="http://q.gbelib.kr/CATE_IMG/79/9991A14A-740F-8DB1-A04B-5DED40095E77.png" alt="전자도서관 이용안내"></a>
												</div>
												<div class="contents">
													<h3 class="book-title"><a href="javascript:void(0);" target="_blank">전자도서관 이용안내</a></h3>
							...
							<!-- /큐레이션 -->
							<div class="l_more_btn"><a href="http://q.gbelib.kr/index.jsp?gid=31" target="_blank"><img src="/resources/homepage/${homepage.context_path}/img/l_more_btn.png" alt="L-큐레이션 더보기"></a></div>
			...
			<div class="main-section">
								...
								<div class="swiper-slide">
									<div class="main-slide1-con">
										<div class="text">
											...
											<p>
												<c:choose>
													<c:when test="${fn:length(i.content) > 224}">
								...
								<span>
									<c:choose>
										<c:when test="${fn:indexOf(j.preview_img, 'http') > -1 }">
											<img src="${j.preview_img}" alt="${j.title}"onError="this.src='/resources/homepage/${homepage.context_path}/img/book_noimg.jpg'" />
										</c:when>
										<c:otherwise>
											<img src="/data/board/${j.manage_idx}/${j.board_idx}/${j.preview_img}" alt="${j.title}"onError="this.src='/resources/homepage/${homepage.context_path}/img/book_noimg.jpg'"/>
										</c:otherwise>
									</c:choose>
								</span>
										...
										<div class="main-slide1-con">
											...
											<div class="photo">
												<a href="javascript:void(0);">
													<img src="/resources/homepage/${homepage.context_path}/img/book_noimg.jpg" alt="등록된 도서가 없습니다." />
												</a>
											</div>
										</div>
									</div>
				...
				<div class="book-box mobile-view">
					...
					<div class="cont bookPickList">
						<c:if test="${fn:length(bookList) > 0}">
						<a href="javascript:void(0);" class="bx-prev">이전</a>
						<ul>
									...
									<div class="thumbnails">
										<c:choose>
											<c:when test="${fn:indexOf(k.preview_img, 'http') > -1 }">
												<img src="${k.preview_img}" alt="${k.title}" onError="this.src='/resources/homepage/${homepage.context_path}/img/book_noimg.jpg'"/>
											</c:when>
											<c:otherwise>
												<img src="/data/board/${k.manage_idx}/${k.board_idx}/${k.preview_img}" alt="${k.title}" onError="this.src='/resources/homepage/${homepage.context_path}/img/book_noimg.jpg'" />
											</c:otherwise>
										</c:choose>
									</div>
