...
<div id="m-util" class="no4">
	<ul>
		...
		<li><a href="https://www.gbelib.kr/sj/index.do" target="_blank">상주도서관</a></li>
		<li class="smart-banner">
			<c:choose>
			<c:when test="${sessionScope.member.loginType eq 'HOMEPAGE' and sessionScope.member.login}">
			<a href="https://nsmart.koedu.co.kr/library.php?chk=Y2hrdGltZT0xNDQ0Nzc1ODE4JmxpYnJhcnk96rK97IOB67aB64%2BE6rWQ7Jyh7LKtIOyDgeyjvOuPhOyEnOq0gCDtmZTroLnrtoTqtIAmdWFzZXJfbmFtZT3qsr3sg4HrtoHrj4TqtZDsnKHssq0g7IOB7KO864%2BE7ISc6rSAIO2ZlOugueu2hOq0gCZ1YXNlcl9pZD1zamhyMDAy" target="_blank">스마트체험도서관</a>
			</c:when>
			<c:otherwise>
			<a href="javascript:alert('로그인 후 이용 바랍니다.'); location.href='/sjhr/intro/login/index.do?menu_idx=121';">스마트체험도서관</a>
			</c:otherwise>
			</c:choose>
		</li>
...
<div class="head">
		<div class="Gnb">
			...
			<div class="wide-sections">
				<h1><a href="http://www.gbelib.kr/${homepage.context_path}/index.do"><img src="/resources/homepage/${homepage.context_path}/img/logo.jpg" alt="${homepage.homepage_name}"/></a></h1>
				...
				<div class="g-menu">
					...
					<div class="mmode">
						<c:choose>
							...
							<a href="https://www.gbelib.kr/${homepage.context_path}/module/myDashBoard/index.do?menu_idx=181" class="btn4">
           						<i class="fa fa-bookmark"></i>
          							 <span>나의도서관</span>
       						  </a>
							<a href="https://www.gbelib.kr/${homepage.context_path}/html/mobileCard.do?menu_idx=207" class="btn2" style="background:#8008d5;">
							<i class="fa fa-bookmark"></i>
								 <span>모바일회원증</span>
							</a>
