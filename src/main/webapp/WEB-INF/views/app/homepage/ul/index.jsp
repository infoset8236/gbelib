					...
					<div class="main0-box-botton">
						<div class="qmenu">
							<ul>
								...
								<li class="qm3">
									<a href="/${homepage.context_path}/module/teach/index.do?menu_idx=191&searchCate1=16,17" title="문화행사신청">
								...
								<li class="qm6">
									<a href="/${homepage.context_path}/board/index.do?menu_idx=74&manage_idx=531" title="자주하는질문">
								...
								<c:choose>
									<c:when test="${sessionScope.member.loginType eq 'HOMEPAGE' and sessionScope.member.login}">
										<c:choose>
										<c:when test="${sessionScope.member.loca eq '00147017'}">

										<c:if test="${not empty sessionScope.member.status_code and sessionScope.member.status_code eq '0'}">
									<a href="https://nsmart.koedu.co.kr/library.php?chk=Y2hrdGltZT0xNDQ0Nzc1ODE4JmxpYnJhcnk97Jq466aJ6rO16rO164%2BE7ISc6rSAJnVhc2VyX25hbWU97Jq466aJ6rO16rO164%2BE7ISc6rSAJnVhc2VyX2lkPXVsbGliMDAy" target="_blank">
										</c:if>
								...
								<li class="qm8">
									<a href="/${homepage.context_path}/html.do?menu_idx=29" title="책바다서비스">
			...
			<div class="main1_wrap">
				<div class="main1-inner-left">			
					<div class="notice-box">
						<div class="title">
							<h3>공지사항</h3>
							<a href="/${homepage.context_path}/board/index.do?menu_idx=58&manage_idx=528" title="공지사항 더보기 버튼">
		...
		<div id="main2" class="section">
			<div class="main2-wrap mid-sections">
				...
				<div class="event-box">
					<div class="title">
						<h3>EVENT</h3>
						<a href="/${homepage.context_path}/module/teach/index.do?menu_idx=191&searchCate1=16,17" title="행사 더보기 버튼">
					...
					<div class="list">
						<ul>
							<c:forEach var="i" items="${teachList}">
								<li>
									<a href="/${homepage.context_path}/module/teach/detail.do?menu_idx=191&searchCate1=${i.large_category_idx}&group_idx=${i.group_idx}&category_idx=${i.category_idx}&teach_idx=${i.teach_idx}&homepage_id=${i.homepage_id}">
										<div>
											<h3>${i.teach_name }</h3>
						...
						<div class="mid-sections">
							<div class="main5-bottom-right">
								<div class="title">
									...
									<a href="/${homepage.context_path}/board/index.do?menu_idx=21&manage_idx=529" class="more"><img src="/resources/common/img/book_type01/book-more-btn.png" alt="더보기" /></a>
								</div>
							</div>
					...
					<div class="banner-wrap type6">
						...
						<div class='banner-t6-after'>
							<div class="control">
								...
								<a class="more" href="/${homepage.context_path}/bannermap/index.do?menu_idx=180"><img src="/resources/homepage/gbelib/img/section04/banner-more-btn.png" alt="더보기" /><span class="blind">더보기</span></a>
							</div>
						</div>
					</div>
				</div>
