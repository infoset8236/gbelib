			...
			<div class="sections">
				<div class="">
					...
					<div class="info">
						...
						<a href="/${homepage.context_path}/html.do?menu_idx=113" style="color:yellow;">개인정보처리방침</a>
						<span class="txt-menu-bar"></span>
						<a href="/${homepage.context_path}/html.do?menu_idx=141">영상정보처리기기운영관리방침</a>
						<span class="txt-menu-bar"></span>
						<a href="/${homepage.context_path}/html.do?menu_idx=152">홈페이지운영방침</a>
						<span class="txt-menu-bar"></span>
						<a href="/${homepage.context_path}/html.do?menu_idx=16">행정서비스헌장</a>
						<span class="txt-menu-bar"></span>
						<a href="/${homepage.context_path}/html.do?menu_idx=17">찾아오시는길</a>
					</div>
					</div>
