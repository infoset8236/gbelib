	...
	<div id="lnbWrap">
		...
		<nav>
			<ul class="clFix">
           		...
           		<li class="menu3 on"><a href="secukeypad_maxlength.jsp">입력 길이 제한</a></li>
		...
		<div class="login_wrap">
			<form id="<%=formName%>" name="<%=formName%>" action="secukeypad_decode.jsp" method="post">
				...
				<fieldset form="login">
					...
					<%-- y-SecuKeypad 키패드 출력 ---%>
					<p class="state">
						<label class="chk_wrap" for="<%=inputPasswdUseYnName%>">가상키패드 사용여부
...
<script type="text/javascript">
	...
	$(document).on("click",".choose_theme .radio_wrap",function(){
		...
		if("darkBlue" == $(this).children().attr("id")){
			pageParameter = "secukeypad_checkbox.jsp?theme=darkBlue";
		}else{
			pageParameter = "secukeypad_checkbox.jsp?theme=basicGrey";
		}
