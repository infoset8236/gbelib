...
$(document).ready(function(){
		...
		if( navigator.platform  ){
			if( filter.indexOf(navigator.platform.toLowerCase())<0 ){
				...
				// pc접속
				data.recordCountPerPage= 3;
			}
		}
		
		data.searchType = 'Tags';
		data.searchKeyword = '경상북도교육청문화원';
		data.orderType = 2;
		data.searchOrder = 'D';
/*
		var data 
    ...
    searchDgitalQ = function(data){
        $.ajax({
            ...
            success: function(response) {
                ...
                html = '<div class="title"><h3>L-큐레이션 <a href="http://q.gbelib.kr/index.jsp?gid=7" target="_blank" class="more-btn"><img src="/resources/homepage/gbccs/img/main/board-more.png" alt="더보기"></a></h3></div>';
				html+= '<div class="list"><div class="bx-controls bx-has-controls-direction"><div class="bx-controls-direction"><a class="bx-prev" id="bxprev" href="javascript:void(0);">Prev</a><a class="bx-next" id="bxnext" href="javascript:void(0);">Next</a></div></div>';
				html+= '<ul>';
