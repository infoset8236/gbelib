...
$(document).ready(function(){
		...
		data.searchKeyword = '경상북도교육청 점촌도서관가은분관';
		data.orderType = 2;
		data.searchOrder = 'D';
/*
		var data 
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                for(var i=0; i< rows.length; i++){
                    ...
                    if(pcPlatform){
                        if(i == 2 || (rows.length < 3&&(rows.length-1)==i)){
                            html +=       '<div class="bx-controls bx-has-controls-direction"><div class="bx-controls-direction"><a class="bx-prev" id="bxprev" href="javascript:void(0);"><img src="/resources/homepage/jcge/img/prev-btn.png" alt="이전" /></a><a class="bx-next" id="bxnext" href="javascript:void(0);"><img src="/resources/homepage/jcge/img/next-btn.png" alt="다음" /></a></div></div>';
                        }
                    }else{
