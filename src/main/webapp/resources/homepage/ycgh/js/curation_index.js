...
$(document).ready(function(){
		...
		data.searchKeyword = '경상북도교육청 금호도서관';
		data.orderType = 2;
		data.searchOrder = 'D';
/*
		var data 
	...
	searchDgitalQ = function(data){
		$.ajax({
			...
			success: function(response) {
				...
				html += '<h3>L-큐레이션 <a href="http://q.gbelib.kr/index.jsp?gid=21" target="_blank" class="more-btn"><img src="/resources/common/img/curation_type04/curation4-more-btn.png" alt="더보기"/></a></h3>';
				html += '</div>';
				html +='<div class="list">';
