...
function Datepicker() {
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		showAnim: "slide", // Name of jQuery animation for popup
		showOptions: {}, // Options for enhanced animations
		defaultDate: "", // Used when field is blank: actual date,
			// +/-number for offset from today, null for today
		appendText: "", // Display text following the input box, e.g. showing the format
		buttonText: "...", // Text for trigger button
		buttonImage: "/resources/cms/survey/schedule/images/calendar.gif", // URL for trigger button image
			...
			for (col = 0; col < numMonths[1]; col++) {
				...
				for (dow = 0; dow < 7; dow++) { // days of the week
					...
					if ((dow + firstDay + 6) % 7 == 5) {
						classTemp = " class='ui-datepicker-week-sat'";
					} else if ((dow + firstDay + 6) % 7 == 6) {
						classTemp = " class='ui-datepicker-week-sun'";
					} else {
						classTemp = "";
					}
					thead += "<th" + classTemp + "><span title='" + dayNames[day] + "'>" + dayNamesMin[day] + "</span></th>";
//					thead += "<th" + 
...
//								+ "><span title='" + dayNames[day] + "'>" + dayNamesMin[day] + "</span></th>";
				...
				for (dRow = 0; dRow < numRows; dRow++) { // create date picker rows
					...
					for (dow = 0; dow < 7; dow++) { // create date picker days
						...
						var classTemp = "";
						if ((dow + firstDay + 6) % 7 == 5) {
							classTemp = " ui-datepicker-week-sat'";
						} else if ((dow + firstDay + 6) % 7 == 6) {
							classTemp = " ui-datepicker-week-sun'";
						} else {
							classTemp = "";
						}
						tbody += "<td class='" +
