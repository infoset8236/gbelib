/*
*  $Id: documentselection.js 679 2009-12-08 19:24:10Z wingedfox $
*  $HeadURL: https://svn.debugger.ru/repos/jslibs/BrowserExtensions/tags/BrowserExtensions.026/documentselection.js $
*
*  Class implements cross-browser work with text selection
*
*  @author Ilya Lebedev
*  @author $Author: wingedfox $
*  @modified $Date: 2009-12-08 22:24:10 +0300 (Втр, 08 Дек 2009) $
*  @version $Rev: 679 $
*  @license LGPL
*/
/*
        ...
        self.setRange = function (el,start,end) {
            if ('function' == typeof el.setSelectionRange) {
                ...
                */
                ...
                var p = self.getPos(el);
               	// not sure if this a certain kind of the bug
               	// but Safari and Chrome does not allow to make a selection against a part of the combined symbol
               	// thus, we'll try to remove the whole combined symbol
                while (start != end && p[0] == p[1]) {
                    start--;
