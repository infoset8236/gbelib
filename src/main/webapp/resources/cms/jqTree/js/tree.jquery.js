  ...
  */
  ...
  JqTreeWidget = (function(_super) {
    ...
    JqTreeWidget.prototype.defaults = {
      ...
      autoEscape: true,
      dataUrl: null,
      closedIcon: '<img src=\"/resources/cms/jqTree/img/ico_closeFolder.gif\"/>', 
      openedIcon: '<img src=\"/resources/cms/jqTree/img/ico_openFolder.gif\"/>',
      slide: true,
      nodeClass: Node,
      dataFilter: null,
    ...
    JqTreeWidget.prototype._refreshElements = function(from_node) {
      ...
      createNodeLi = function(node) {
        ...
        var menu_type = node.menu_type; 
        
        if(menu_type == 'BOARD') {
        	return $("<li class=\"" + class_string + "\"><div class=\"jqtree-element jqtree_common\"><img src=\"/resources/cms/jqTree/img/icon-bbs.gif\" style=\"vertical-align:bottom; margin-right:3px\"><span class=\"jqtree-title jqtree_common\">" + escaped_name + "</span></div></li>");
        } else if(menu_type == 'HTML') {
        	return $("<li class=\"" + class_string + "\"><div class=\"jqtree-element jqtree_common\"><img src=\"/resources/cms/jqTree/img/icon-html.gif\" style=\"vertical-align:bottom; margin-right:3px\"><span class=\"jqtree-title jqtree_common\">" + escaped_name + "</span></div></li>");
        } else if(menu_type == 'PROGRAM') {
        	return $("<li class=\"" + class_string + "\"><div class=\"jqtree-element jqtree_common\"><img src=\"/resources/cms/jqTree/img/icon-program.gif\" style=\"vertical-align:bottom; margin-right:3px\"><span class=\"jqtree-title jqtree_common\">" + escaped_name + "</span></div></li>");	
        } else if(menu_type == 'LINK' || menu_type == 'LINK_OUTER') {
        	return $("<li class=\"" + class_string + "\"><div class=\"jqtree-element jqtree_common\"><img src=\"/resources/cms/jqTree/img/icon-link.gif\" style=\"vertical-align:bottom; margin-right:3px\"><span class=\"jqtree-title jqtree_common\">" + escaped_name + "</span></div></li>");	
        } else {
        	return $("<li class=\"" + class_string + "\"><div class=\"jqtree-element jqtree_common\"><img src=\"/resources/cms/jqTree/img/icon-default.gif\" style=\"vertical-align:bottom; margin-right:3px\"><span class=\"jqtree-title jqtree_common\">" + escaped_name + "</span></div></li>");
        }
      };
