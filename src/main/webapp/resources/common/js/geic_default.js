...
$(function(){
	...
	$('div.lnb > ul > li').each(function(){
		if($(this).find('ul').length > 0){
			...
			if($(this).hasClass('active')){
				$(this).children('a').append('<img src="resources/common/img/active_on.png" alt="on"/>');
			}else{
				$(this).children('a').append('<img src="resources/common/img/active_off.png" alt="off"/>');
			}
	...
	var apiData = 'pageIndex=1&recordCountPerPage=10&searchType=Title&searchKeyword=&orderType=2&searchOrder=D';
	$.ajax({
		url: 'http://q.gbelib.kr/curation/api/boardList.json',
		method: "POST",
		dataType: 'jsonp',
		jsonp: "callback",
		data: apiData,
