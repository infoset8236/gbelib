				...
				<div class="info">
					...
					<address>
						<p>
							...
							<em>PC • 모바일기기 오류 및 기술문의 070-8768-8902</em>
							<em>일반문의 ${homepage.homepage_tell }</em> 
		...
		<div class="bottom-box">
			<div class="sections">
				<div class="">
					...
					<div class="info">
						<a href="http://www.gbelib.kr/geic/html.do?menu_idx=99" target="_blank"><b style="color:yellow;">개인정보처리방침</b></a>
