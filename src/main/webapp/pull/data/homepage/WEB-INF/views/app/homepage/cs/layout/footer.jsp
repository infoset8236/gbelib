				...
				<div class="info-right">
					<div class="site_link">
						...
						<div class="sns">
							...
							<a href="http://dream.nld.go.kr/dream/index.do" target="_blank"><img src="/resources/homepage/${homepage.context_path}/img/foot-link-icon02.png" onmouseover="this.src='/resources/homepage/${homepage.context_path}/img/foot-link-icon02-on.png'" onmouseout="this.src='/resources/homepage/${homepage.context_path}/img/foot-link-icon02.png'" alt="책나래 홈페이지 바로가기(새창열림)"/></a>
