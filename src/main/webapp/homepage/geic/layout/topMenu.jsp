		...
		<div class="Gnb">
			...
			<div class="wide-sections">
				...
				<div class="g-menu">
					...
					<a href="" class="last-box-a"><img src="/resources/common/img/sitemap_icon_b.png" alt="사이트맵" class="last-box"></a>
					...
					<div class="mmode">
						<c:choose>
							...
							<a href="https://www.gbelib.kr/${homepage.context_path}/intro/search/loan/index.do?menu_idx=115" class="btn4">
