...
<h2 class="center">제 1 장  총 칙</h2>
<br/><h3>제 1 조 (목적)</h3>
<p class="mB20 mL10">본 약관은 경상북도교육정보센터(이하 "당 사이트"라 함)가 제공하는 모든 서비스의 이용조건 및 절차, 이용자와 당 사이트의 권리, 의무, 책임사항과 기타 필요한 기본적인 사항을 정함을 목적으로 한다.</p>
<br/><h3>제 2 조 (이용약관의 효력 및 변경)</h3>
<ul class="mB20 mL10">
...
<br/><h3>제 3 조 (약관의 적용)</h3>
<ul class="mB20 mL10">
  <li>① 이 약관은 교육정보센터가 제공하는 개별서비스에 관한 이용안내와 함께 적용한다.</li>
  <li>② 이 약관에 명시되지 아니한 사항에 대해서는 정보통신 관계법령 및 서비스별 안내의 취지에 따라 적용할 수 있다.</li>
</ul>
<br/><h3>제 4 조 (용어의 정의)</h3>
...
<ul class="mB20 mL10">
  ...
  <li>⑥ 회원은 2년을 주기로 재동의 절차를 거치지 않은 경우 회원의 자격을 상실할 수 있다.</li>
</ul>
<br/><h3>제 7 조 (회원ID 부여 및 변경 등)</h3>
<ul class="mB20 mL10">
  ...
  <li>③ 회원ID는 다음 각 호에 해당하는 경우에는 이용자 또는 교육정보센터의 요청으로 변경할 수 있다.</li>
  <li>
    <ul class="mB20 mL20">
...
<ul class="mB20 mL10">
  ...
  <li>
    <ul class="mB20 mL20">
      ...
      <li>
        <ul class="mB20 mL20">
          <li>- 필수항목 : 이름, 이메일, 주소, 학생의 경우(학교명, 학년)</li>
          <li>- 선택항목 : 휴대전화</li>
        </ul>
      </li>
...
<br/><h3>제 11 조 (서비스의 중지 및 중지에 대한 공지)</h3>
<ul class="mB20 mL10">
  ...
  <li>② 당 사이트가 정상적인 서비스 제공의 어려움으로 인하여 일시적으로 서비스를 중지하여야 할 경우에는 서비스 중지 1주일 전에 홈페이지에 서비스 중지사유 및 일시를 공지한 후 서비스를 중지할 수 있으며, 이 기간 동안 이용자가 공지내용을 인지하지 못한 데 대하여 당 사이트는 책임을 지지 않는다. 부득이한 사정이 있을 경우 위 사전 공지기간은 감축되거나 생략될 수 있다. 또한 위 서비스 중지에 의하여 본 서비스에 보관되거나 전송된 메시지 및 기타 통신 메시지 등의 내용이 보관되지 못하였거나 삭제된 경우, 전송되지 못한 경우 및 기타 통신 데이터의 손실이 있을 경우에 대하여도 당 사이트는 책임을 지지 않는다.</li>
...
<br/><h3>제 12 조 (정보 제공 및 홍보물 게재)</h3>
<ul class="mB20 mL10">
  <li>① 당 사이트는 서비스를 운영함에 있어서 각종 정보를 홈페이지에 게재하는 방법, 전자우편이나 서신우편 발송, 필요하다고 인정되는 다양한 정보를 제공할 수 있다. </li>
  <li>② 당 사이트는 서비스에 적절하다고 판단되거나 공익성이 있는 홍보물을 게재할 수 있다.</li>
</ul>
<br/><h3>제 13 조 (당 사이트 게시물의 관리,운영)</h3>
<ul class="mB20 mL10">
...
<br/><h3>제 21 조 (관할법원)</h3>
<p class="mB20 mL10">본 서비스 이용과 관련하여 발생한 분쟁에 대해 소송이 제기될 경우 대구지방법원을 관할 법원으로 한다.</p>
<br/><h3>부 칙</h3>
<p class="mB20 mL10">① (시행일) 이 약관은 2005년 3월 14일부터 시행한다.</p>
<br/><h3>부 칙</h3>
<p class="mB20 mL10"> ① (시행일) 이 약관은 2009년 3월 13일부터 시행한다.</p>
<p class="mB10 mL10">* 본 약관에 대한 저작권은 경상북도교육정보센터에 귀속되며 무단복제, 배포, 전송, 기타 저작권 침해행위를 엄금한다.</p>
